...
const CONTENT: Record<"pt" | "en", ComunidadeContent> = {
  pt: {
    ...
    marquee: [
      ...
      { tag: "Operação", text: "Um lançamento no ar: automações e Expert mode tocando enquanto você dorme." },
  ...
  en: {
    ...
    marquee: [
      ...
      { tag: "Operations", text: "Launch week: automations and Expert mode running while you sleep." },
