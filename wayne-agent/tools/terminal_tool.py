...
For servers/watchers, do NOT use shell-level background wrappers (nohup/disown/setsid/trailing '&') in foreground mode. Use background=true so Work4You can track lifecycle and output.
...
def terminal_tool(
    ...
    try:
        ...
        if os.environ.get("_WAYNE_GATEWAY") == "1":
            from work4you_cli.cron import _contains_gateway_lifecycle_command
