...
# The loopback redirect registered for the Wayne OAuth client. IP-literal so
...
_DEFAULT_CLIENT_ID = "wayne-agent"
...
def begin_authorization(
    ...
    *,
    ...
    (``wayne-desktop`` / ``wayne-cli``) so the consent side can attribute
...
_CALLBACK_HTML = (
    ...
    b"<div>Connected to Honcho. You can close this tab and return to Wayne.</div>"
)
...
def start_loopback_flow_background(
    *,
    ...
    # the request, where a context-local WAYNE_HOME override can't reach.
