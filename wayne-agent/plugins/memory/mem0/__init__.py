...
setup`):
  ...
  agent_id           — Agent identifier (default: wayne)
...
def _load_config() -> dict:
    """Load config from env vars, with $WAYNE_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "wayne"),
        "oss": {},
    }
    ...
    config_path = get_wayne_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, wayne_home):
        """Write config to $WAYNE_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $WAYNE_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "wayne")
