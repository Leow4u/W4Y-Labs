...
``_check_spotify_available()`` — when the user has not run ``wayne auth
spotify``, the tools remain registered (so they appear in ``wayne
...
The Spotify auth flow (``wayne auth spotify``), CLI plumbing, and docs
