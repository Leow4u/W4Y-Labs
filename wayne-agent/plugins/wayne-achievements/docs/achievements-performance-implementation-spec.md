# Wayne Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.wayne/plugins/wayne-achievements/state.json` (existing unlock state)
  - `~/.wayne/plugins/wayne-achievements/scan_snapshot.json` (new)
  - `~/.wayne/plugins/wayne-achievements/scan_checkpoint.json` (new)
