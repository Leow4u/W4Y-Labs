# Wayne Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.wayne/plugins/wayne-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.wayne/plugins/wayne-achievements/scan_checkpoint.json`.
