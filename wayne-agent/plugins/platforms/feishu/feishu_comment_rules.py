...
Config: ~/.wayne/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.wayne/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_wayne_home()`` helper (WAYNE_HOME-aware and
...
RULES_FILE = get_wayne_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_wayne_home() / "feishu_comment_pairing.json"
