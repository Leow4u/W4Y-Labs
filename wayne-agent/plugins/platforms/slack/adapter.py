...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            # Wayne does not currently need to route them into the agent loop.
            ...
            for _action_id in (
                "wayne_approve_once",
                "wayne_approve_session",
                "wayne_approve_always",
                "wayne_deny",
            ):
            ...
            for _action_id in (
                "wayne_confirm_once",
                "wayne_confirm_always",
                "wayne_confirm_cancel",
            ):
    ...
    def _dm_top_level_threads_as_sessions(self) -> bool:
        ...
        own Wayne session — matching the per-thread behavior channels already
    ...
    async def _handle_slack_message(self, event: dict) -> None:
        ...
        if original_text.startswith("!"):
            try:
                ...
                # forms like ``!stop@wayne`` still resolve.
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "wayne_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "wayne_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "wayne_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "wayne_confirm_once",
                            "value": value,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Approve"},
                            "action_id": "wayne_confirm_always",
                            "value": value,
                        },
                        {
                            "type": "button",
                            ...
                            "style": "danger",
                            "action_id": "wayne_confirm_cancel",
                            "value": value,
                        },
                    ],
                },
    ...
    async def _handle_slash_confirm_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "wayne_confirm_once": "once",
            "wayne_confirm_always": "always",
            "wayne_confirm_cancel": "cancel",
        }
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "wayne_approve_once": "once",
            "wayne_approve_session": "session",
            "wayne_approve_always": "always",
            "wayne_deny": "deny",
        }
