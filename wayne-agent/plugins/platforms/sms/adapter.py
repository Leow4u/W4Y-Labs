...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Wayne gateway adapter.

    Each inbound phone number gets its own Wayne session (multi-tenant).
...
# static dict in wayne_cli/gateway.py, and the _send_sms dispatch in
