"""
Photon Spectrum (iMessage) platform adapter for Wayne Agent.
...
if TYPE_CHECKING:
    ...
    try:
        import httpx
        HTTPX_AVAILABLE = True
    except ImportError:  # pragma: no cover - httpx is already a Wayne dep
...
class PhotonAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> "list[re.Pattern]":
        ...
        list, or comma/newline-separated), or None (use Wayne defaults).
    ...
    async def _inbound_loop(self) -> None:
        ...
        headers = {"X-Wayne-Sidecar-Token": self._sidecar_token}
        backoff = 1.0
    ...
    def _pid_is_sidecar(pid: int) -> bool:
        ...
        try:
            ...
            return False
        # Checkout-agnostic: any Wayne checkout's sidecar entry point.
...
async def _standalone_send(
    ...
    *,
    ...
    headers = {"X-Wayne-Sidecar-Token": token}
