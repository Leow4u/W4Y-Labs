...
```bash
node apps/work4you/scripts/measure-latency.mjs --chars=120 --cps=20
```
...
node apps/work4you/scripts/leak-typing.mjs --rounds=8 --chars=200 --cps=50
```
...
```bash
node apps/work4you/scripts/profile-typing.mjs \
...
See commit message for `apps/work4you/src/app/chat/composer/index.tsx`
edits. Three changes:
