...
export function DesktopController() {
  ...
  useEffect(() => {
    if (!productRuntime.capabilities.gcsUpdate) {
      return
    }
  ...
  }, [productRuntime.capabilities.gcsUpdate])
  ...
  useEffect(() => {
    ...
    void applyCloudFirstRunTargetDefault()
  }, [productRuntime.capabilities.cloudBridge])
