...
export const en: Translations = {
  ...
  settings: {
    ...
    connections: {
      ...
      stagedNote:
        'Switch gateways from Sessions. Profiles, chats, messaging, and scheduled jobs stay with their gateway; work on other gateways keeps running.',
      ...
      kindCloudDesc: 'A hosted instance discovered through your Work4You account.',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted.',
      ...
      cloudAddHint:
        'Tip: signing in under Work4You Cloud discovers your agents automatically — use this form only to register a known instance URL by hand.',
      save: 'Save connection',
      saving: 'Saving…',
      cancel: 'Cancel',
      empty: 'No connections registered yet.',
      plainTextConfirmTitle: 'Store token without keyring encryption?',
      plainTextConfirmDesc:
        'This device cannot use the OS keyring. Saving will store the token in plain text unless you cancel.',
      plainTextConfirmAction: 'Save anyway'
    },
    gateway: {
    ...
    toolsets: {
      ...
      ready: 'Ready',
      nousIncluded: 'Included with a Work4You subscription — sign in to your account to activate.',
  ...
  cron: {
    ...
    toolsSection: 'Tools',
    toolsHint:
      'Choose which apps and tools this automation may use. Connectors and delivery are per automation — they do not change global profile settings.',
    openConnectors: 'Connectors',
    openChannels: 'Channels',
    addJobConnector: 'Connectors',
