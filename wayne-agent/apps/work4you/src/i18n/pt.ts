...
/** Portuguese (Brasil) — desktop catalog; merges over EN via defineLocale. */
export const pt = defineLocale({
  ...
  settings: {
    ...
    browserNetwork: {
      ...
      intro: 'Controla se o Work4You e o navegador podem acessar à sua rede local, localhost e endereços privados — necessário em muitos fluxos reais.',
    ...
    advancedPage: {
      ...
      fields: {
        ...
        'updates.non_interactive_local_changes': {
          ...
          description: 'Quando a app se atualiza sozinha (sem prompt no terminal), guardar edições locais (stash) ou descartá-las. Atualizações no terminal perguntam sempre.',
        },
      },
    },
    model: {
    ...
    memoryPage: {
      ...
      manageDesc: 'Edite o perfil que o Work4You usa sobre si. Onde guardar e resumir chats longos ficam nesta página.',
    ...
    safety: {
      ...
      yoloDisarmFailed: 'Guardado, mas esta conversa continua a ignorar permissões. Use /yolo ou abra uma conversa nova para a limpar.',
      fields: {
        'approvals.mode': {
        ...
        'security.allow_private_urls': {
          ...
          description: 'Deixa as ferramentas acessar a endereços na sua rede local / privada.',
        },
    ...
    notifications: {
      ...
      completionSoundDesc: 'Som do app quando um turno termina em segundo plano — não é o ding do Windows/macOS. Pré-ouça ou use Enviar teste para ouvir.',
    ...
    about: {
      ...
      localChangesDesc: 'Se a app se atualizar sozinha (sem prompt no terminal), guardar edições locais (stash) ou descartá-las. Atualizações no terminal perguntam sempre.',
      localChangesOptions: {
        stash: 'Salvar (stash)',
        discard: 'Descartar',
      },
    ...
    fieldDescriptions: {
      ...
      'display.showReasoning': 'Mostra o raciocínio do modelo quando ele o compartilha. Não afeta o status de trabalho, os temporizadores nem o progresso das ferramentas.',
      timezone: 'Usado quando o Work4You precisa do horário local como contexto. Em branco, usa o fuso horário do sistema.',
      'agent.imageInputMode': 'Como as imagens anexadas são enviadas ao modelo.',
      'agent.maxTurns': 'Limite máximo de turnos com uso de ferramentas antes de o Work4You encerrar uma execução.',
      'agent.apiMaxRetries': 'Quantas vezes repetir uma chamada à API do modelo que falhou.',
      'agent.serviceTier': 'Nível de serviço opcional do provedor (OpenAI/Anthropic). Deixe como none para usar o padrão.',
      'agent.toolUseEnforcement': 'Com que rigor o modelo deve usar ferramentas quando um turno espera esse uso (auto/force/off).',
      'terminal.cwd': 'Pasta de projeto padrão para o trabalho com ferramentas e terminal.',
      'terminal.backend': 'Onde os comandos do shell são executados (máquina local, Docker, serviços de nuvem, …).',
      'terminal.timeout': 'Segundos até um único comando do terminal ser encerrado.',
      ...
      'codeExecution.mode': 'Com que rigor a execução de código fica restrita ao projeto atual.',
      fileReadMaxChars: 'Máximo de caracteres que o Work4You pode ler em uma única solicitação de arquivo.',
      'toolOutput.maxBytes': 'Máximo de bytes de um único resultado de ferramenta ou terminal mantido no contexto.',
      'toolOutput.maxLines': 'Máximo de linhas mantidas de um resultado longo de ferramenta.',
      'toolOutput.maxLineLength': 'Máximo de caracteres por linha antes do truncamento.',
      'approvals.mode': 'Como o Work4You lida com comandos que exigem aprovação explícita.',
      'approvals.timeout': 'Segundos de espera pela sua resposta antes de uma solicitação de aprovação expirar.',
      'approvals.mcpReloadConfirm': 'Pede confirmação antes de recarregar conectores MCP durante uma sessão.',
      'security.redactSecrets': 'Oculta, quando possível, os segredos detectados no conteúdo visível ao modelo.',
      'checkpoints.enabled': 'Cria snapshots de restauração antes de editar arquivos.',
      'checkpoints.maxSnapshots': 'Quantidade de checkpoints de arquivos mantidos antes de os mais antigos serem descartados.',
      ...
      'memory.memoryCharLimit': 'Orçamento aproximado de caracteres para as anotações de memória armazenadas.',
      'memory.userCharLimit': 'Orçamento aproximado de caracteres para o perfil do usuário.',
      'memory.provider': 'Onde a memória duradoura é armazenada. Neste computador, funciona offline.',
      ...
      'compression.threshold': 'Quanto da janela de contexto deve estar preenchido antes de a compactação ser executada (0–1).',
      'compression.targetRatio': 'Quanto da janela deve ser liberado quando a compactação for executada (0–1).',
      'compression.protectLastN': 'Mantém as últimas N mensagens intactas durante o resumo.',
      'delegation.model': 'Modelo ativo usado pelos subagentes delegados. Em branco, herda o modelo do chat principal.',
      'delegation.provider': 'Caminho de API e credenciais dos subagentes. Definido automaticamente ao escolher um modelo de subagente.',
      'delegation.maxIterations': 'Máximo de turnos com ferramentas para cada subagente.',
      'delegation.maxConcurrentChildren': 'Quantidade de subagentes que podem trabalhar em paralelo.',
      'delegation.childTimeoutSeconds': 'Encerra um subagente após esta quantidade de segundos (0 = sem limite).',
      'delegation.reasoningEffort': 'Nível de raciocínio dos subagentes delegados.',
      'voice.autoTts': 'Lê automaticamente as respostas do assistente em voz alta.',
      'tts.xai.voiceId': 'ID de voz da xAI (por exemplo, eve) ou um ID de voz personalizado.',
      'tts.xai.language': 'Código do idioma falado, por exemplo, pt.',
      ...
      'stt.echoTranscripts': 'Publica no chat a transcrição bruta 🎙️ das mensagens de voz.',
      'stt.elevenlabs.languageCode': 'Código de idioma ISO 639-3 opcional. Em branco, permite que a ElevenLabs detecte automaticamente.',
      'updates.nonInteractiveLocalChanges': 'Quando o Work4You se atualiza pelo aplicativo (sem prompt no terminal), mantém as edições locais do código-fonte (stash) ou as descarta (discard). Atualizações pelo terminal sempre perguntam.',
    },
    fieldLabels: {
      model: 'Modelo padrão',
      ...
      'display.showReasoning': 'Mostrar raciocínio',
      'agent.maxTurns': 'Máximo de etapas do agente',
      'agent.imageInputMode': 'Imagens anexadas',
      ...
      'toolOutput.maxLines': 'Limite de páginas do arquivo',
      ...
      'approvals.timeout': 'Tempo limite da aprovação',
      ...
      'checkpoints.enabled': 'Checkpoints de arquivos',
      ...
      'stt.elevenlabs.diarize': 'Separar falantes',
      ...
      'compression.targetRatio': 'Meta da compactação',
      ...
      'updates.nonInteractiveLocalChanges': 'Alterações locais em atualizações pelo aplicativo',
    },
    gateway: {
  ...
  messaging: {
    ...
    whatsappUnpairedError: 'O WhatsApp está ativo mas ainda não foi pareado. Completa os passos do QR acima e reinicia o Gateway na barra de estado.',
    ...
    fieldCopy: {
      ...
      SLACK_APP_TOKEN: {
        ...
        placeholder: 'Cole o token do app',
      },
      SLACK_ALLOWED_USERS: {
        label: 'Quem pode falar com o agente',
    ...
    platformCopy: {
      whatsapp: {
        name: 'WhatsApp',
        desc: 'Número pessoal via QR. O agente usa o mesmo WhatsApp do app no telemóvel.',
      },
      whatsapp_cloud: {
  ...
  accountGate: {
    ...
    updateAvailable: 'Há uma atualização do app disponível.',
    updateNow: 'Atualizar agora',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `Isso adiciona o padrão “${pattern}” à sua lista permanente de permissões (~/.work4you/config.yaml). O Work4You não voltará a perguntar sobre comandos como este — nesta sessão nem nas próximas.`,
