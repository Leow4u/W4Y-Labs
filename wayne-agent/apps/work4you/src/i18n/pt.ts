...
export const pt = defineLocale({
  ...
  composer: {
    ...
    brainHandoffHint: 'Copia o thread para uma nova sessão no outro cérebro.',
    brainHandoffNote: 'Abre sessão nova com contexto do transcript (handoff seguro para cache).',
    brainHandoffFailed: 'Não foi possível mover este chat',
  ...
  cron: {
    ...
    toolsSummaryDefault: 'Perfil predefinido',
