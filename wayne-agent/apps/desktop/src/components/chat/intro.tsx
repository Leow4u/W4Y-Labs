...
/**
 * Empty-session intro — short i18n headline + rotating body, no brand wordmark.
 */
export function Intro({ personality, seed }: IntroProps) {
  ...
  return (
    <div
      className="pointer-events-none flex w-full min-w-0 flex-col items-center justify-center px-0.5 py-4 text-center text-muted-foreground sm:px-6 lg:px-8"
      data-slot="aui_intro"
    >
