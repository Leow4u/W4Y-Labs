...
def _profile_user_agent() -> str:
    """Return a ``wayne-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from wayne_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"wayne-cli/{_ver}"
    except Exception:
        return "wayne-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # wayne-cli UA so the catalog endpoint is reachable.
