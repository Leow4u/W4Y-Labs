...
- wayne gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `wayne setup` on a fresh Pi.
    ...
    wayne_cli/stdio.py::configure_windows_stdio() runs later from the entry
