...
TIPS = [
    ...
    "work4you chat --max-turns 200 overrides the default 90-iteration limit per turn.",
    ...
    "work4you model routes vision, compression, and aux tasks to cheaper models — cuts background token cost 85%+ without downgrading your main model.",
    ...
    "Work4You loads project context from .wayne.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    # --- MCP ---
    "work4you mcp opens an interactive picker of Nous-approved MCPs you can install in one keystroke.",
    "work4you mcp catalog lists Nous-approved MCP servers shipped with the repo.",
    ...
    "work4you auth add nous or work4you auth add openai-codex sets up OAuth-based providers.",
    ...
    "Profiles scope Work4You state via WAYNE_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    'work4you import restores a session export or profile archive produced by sessions export or profile export.',
