"""``wayne tools`` subcommand parser.

Extracted from ``wayne_cli/main.py:main()`` (god-file Phase 2 follow-up).
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'wayne tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # wayne tools disable <name...> [--platform cli]
    ...
    # wayne tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `wayne tools` runs after you pick a provider that\n"
