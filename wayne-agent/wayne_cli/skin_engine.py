"""Wayne CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.wayne/skins/ or as built-in presets.
...
.. code-block:: python
    ...
    from wayne_cli.skin_engine import get_active_skin, list_skins, set_active_skin
...
Drop a YAML file in ``~/.wayne/skins/<name>.yaml`` following the schema above.
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Wayne — gold and kawaii",
        "colors": {
