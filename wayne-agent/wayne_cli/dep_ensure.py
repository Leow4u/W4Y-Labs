...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-WayneHome", str(get_wayne_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = wayne_subprocess_env(inherit_credentials=False)
