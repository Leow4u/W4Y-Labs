"""wayne memory setup|status — configure memory provider plugins.
...
# ---------------------------------------------------------------------------
# Curses-based interactive picker (same pattern as wayne tools)
# ---------------------------------------------------------------------------
...
def cmd_setup_provider(provider_name: str) -> None:
    ...
    if hasattr(provider, "post_setup"):
        ...
        provider.post_setup(wayne_home, config)
        return
