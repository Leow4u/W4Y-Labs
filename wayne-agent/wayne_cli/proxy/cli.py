...
def _print_aiohttp_missing() -> None:
    print(
        "work4you proxy requires aiohttp. Install one of:\n"
...
def cmd_proxy_start(args: Any) -> int:
    ...
    print(
        f"Starting the Work4You proxy for {adapter.display_name}\n"
...
def cmd_proxy(args: Any) -> int:
    ...
    print(
        ...
        "\n"
        "Subcommands:\n"
        "  work4you proxy start [--provider nous|xai] [--host 127.0.0.1] [--port 8645]\n"
