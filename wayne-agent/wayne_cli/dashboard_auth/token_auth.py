...
How it fits the existing auth framework:
  ...
  * :func:`token_auth_middleware` runs OUTERMOST (installed last in
    ...
    :class:`~wayne_cli.dashboard_auth.base.TokenPrincipal` to
...
from wayne_cli.dashboard_auth import list_token_providers
from wayne_cli.dashboard_auth.audit import AuditEvent, audit_log
from wayne_cli.dashboard_auth.base import ProviderError, TokenPrincipal
