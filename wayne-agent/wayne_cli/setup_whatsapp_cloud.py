...
Entry point: ``wayne whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``wayne_cli/main.py``).
...
Wayne gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Wayne to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Wayne needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Wayne gateway in another terminal:")
    print("         wayne gateway")
    print()
