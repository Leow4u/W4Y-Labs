...
Invoked by ``wayne kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Wayne Agent board.
...
def _profile_author() -> str:
    """Mirror of ``wayne_cli.kanban._profile_author``."""
    return (
