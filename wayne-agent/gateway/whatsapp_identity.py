...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$WAYNE_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_wayne_dir("platforms/whatsapp/session", "whatsapp/session")
