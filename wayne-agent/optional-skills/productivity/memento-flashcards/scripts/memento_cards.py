...
Data file: $WAYNE_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_WAYNE_HOME = Path(os.environ.get("WAYNE_HOME", Path.home() / ".wayne"))
DATA_DIR = _WAYNE_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
