...
4. Name the token (e.g., "Wayne Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${WAYNE_HOME:-~/.wayne}/.env`:
...
```bash
CANVAS="python $WAYNE_HOME/skills/productivity/canvas/scripts/canvas_api.py"
