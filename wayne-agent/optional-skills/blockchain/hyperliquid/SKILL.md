...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Wayne Agent
license: MIT
...
The script reads `${WAYNE_HOME:-~/.wayne}/.env` for two optional defaults:
...
Helper script: `~/.wayne/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.wayne/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${WAYNE_HOME:-~/.wayne}/.env`.
...
```bash
python3 ~/.wayne/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.wayne/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
