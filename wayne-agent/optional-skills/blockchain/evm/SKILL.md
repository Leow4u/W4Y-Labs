...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Wayne Agent
license: MIT
...
Helper script path: `~/.wayne/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.wayne/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.wayne/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.wayne/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
