...
- User wants **Work4You itself to drive a browser** → use Work4You's built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
