...
author: Wayne Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT)
metadata:
  wayne:
...
# $WAYNE_OSINT_CACHE/icij/ (default: ~/.cache/work4you-osint/icij/).
...
# Set WAYNE_OSINT_UA=your-app/1.0 (your@email) to identify yourself
