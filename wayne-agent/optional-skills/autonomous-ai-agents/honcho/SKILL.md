...
# creates host block wayne_coder, AI peer "coder", inherits config from default
```

What `--clone` does for Honcho:
1. Creates a `wayne_coder` host block in `honcho.json`
