...
key is present in `${WAYNE_HOME:-~/.work4you}/.env` (or macOS Keychain) before firing the kanban.
...
preference: macOS Keychain → `${WAYNE_HOME:-~/.work4you}/.env` → environment variable.
