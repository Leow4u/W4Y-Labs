...
for the platform plumbing. The Work4You-side `computer_use` tool exposed
in this skill is a higher-level Work4You vocabulary; the raw cua-driver
...
When `cua-driver skills install` autodetects Work4You (planned follow-up
