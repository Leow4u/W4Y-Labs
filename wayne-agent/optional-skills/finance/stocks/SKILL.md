...
version: 0.1.0
author: Mibay (Mibayy), Wayne Agent
license: MIT
...
```
SCRIPT=~/.wayne/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.wayne/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
