"""
Cron job scheduling system for Wayne Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    wayne gateway install    # Install as a user service
    sudo wayne gateway install --system  # Linux servers: boot-time system service
    wayne gateway            # Or run in foreground
