#!/usr/bin/env python3
"""Build the Wayne Model Catalog — a centralized JSON manifest of curated models.
...
Wayne CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Wayne release.
