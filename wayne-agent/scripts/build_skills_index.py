#!/usr/bin/env python3
"""Build the Wayne Skills Index — a centralized JSON catalog of all skills.
...
`wayne skills search/install` can use it without hitting the GitHub API.
...
# Ensure WAYNE_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Wayne Skills Index...", flush=True)
