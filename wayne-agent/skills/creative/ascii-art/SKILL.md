...
```bash
python3 -m pyfiglet "WAYNE" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=WAYNE&font=Slant" | boxes -d stone
```
