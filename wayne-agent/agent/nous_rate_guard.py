...
(3 SDK retries x 3 Wayne retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = os.path.join(os.path.expanduser("~"), ".wayne")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Wayne, ...) behind one endpoint.  A 429 can mean either:
