...
def dump_api_request_debug(
    ...
    *,
    ...
    try:
        ...
        # originate from untrusted input (X-Wayne-Session-Id header), and an
        ...
        if env_var_enabled("WAYNE_DUMP_REQUEST_STDOUT"):
...
def create_openai_client(agent, client_kwargs: dict, *, reason: str, shared: bool) -> Any:
    ...
    # Delegate all rate-limit / 5xx retry to wayne's outer conversation loop,
...
def sanitize_api_messages(messages: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    #
    # We do NOT drop the call: wayne' own dispatch loop intentionally keeps an
