...
def _ollama_context_limit_error(agent: Any, request_tokens: int) -> Optional[str]:
    ...
    logger.warning(
        "Ollama runtime context too small for Wayne tool use: "
    ...
    return (
        ...
        f"context, but Wayne needs at least {MINIMUM_CONTEXT_LENGTH:,} tokens "
        "for reliable tool use.\n\n"
        "Increase the Ollama context for this model and restart/reload the "
        "model before trying again. A known-good starting point is 65,536 "
        "tokens. In Wayne config, set `model.ollama_num_ctx: 65536` "
...
def run_conversation(
    ...
    # all run inside Codex). Default Wayne path is bypassed entirely.
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        # cache prefix.  The system prompt is reserved for Wayne internals.
        #
        # Wayne invariant: the system prompt is built ONCE per session
        ...
        if _runtime_context_error:
            ...
            agent._emit_status("❌ Ollama runtime context is too small for Wayne tool use")
            api_call_count -= 1
            agent._api_call_count = api_call_count
            try:
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                if env_var_enabled("WAYNE_DUMP_REQUESTS"):
                ...
                # providers (DeepSeek, Kimi, MiMo, Wayne).  A 429 can
                ...
                # which Wayne' system prompt + tool schemas alone exceed.
        ...
        try:
            ...
            if assistant_message.tool_calls:
                ...
                try:
                    ...
                    # terminates Wayne mid-turn, resume logic still sees the
