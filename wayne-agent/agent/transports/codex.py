...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Wayne's web-provider config and
        ...
        # native search engine for xAI sessions instead of Wayne's
        # configured web provider (Tavily/etc.), and those results bypass
        # Wayne's tool-trace / citation plumbing (they arrive baked into the
