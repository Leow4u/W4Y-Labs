...
def wayne_client_tag() -> str:
    """Return the ``client=...`` tag for Nous Portal requests.

    Format: ``client=wayne-client-v<MAJOR>.<MINOR>.<PATCH>``.
    """
    return f"client=wayne-client-v{_wayne_version()}"
...
def nous_portal_tags() -> List[str]:
    ...
    """
    return ["product=wayne-agent", wayne_client_tag()]
