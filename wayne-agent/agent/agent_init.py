...
def init_agent(
    ...
    agent._cache_ttl = "5m"
    try:
        from work4you_cli.config import load_config as _load_pc_cfg
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        try:
            from work4you_cli.config import load_config as _load_br_cfg
    ...
    try:
        from work4you_cli.config import load_config as _load_sess_cfg
    ...
    try:
        from work4you_cli.config import load_config as _load_agent_config
    ...
    if not agent.quiet_mode and (agent.platform or "cli") != "cli":
        try:
            from work4you_cli.model_switch import _check_wayne_model_warning
