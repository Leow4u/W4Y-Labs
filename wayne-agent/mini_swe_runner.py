#!/usr/bin/env python3
"""
SWE Runner with Wayne Trajectory Format

A runner that uses Wayne-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Wayne-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Wayne-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Wayne format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Wayne-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Wayne-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Wayne Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Wayne-Agent's built-in execution environments
    and outputs trajectories in Wayne-Agent format.
    """
    ...
    def _convert_to_wayne_format(
        ...
        """
        Convert internal message format to Wayne trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Wayne trajectory format
        trajectory = self._convert_to_wayne_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Wayne trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Wayne Trajectory Format")
    print("=" * 60)
