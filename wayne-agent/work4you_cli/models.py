...
# in work4you_cli/web_server.py and ``partition_nous_models_by_tier`` — which can
...
def get_curated_nous_model_ids() -> list[str]:
    ...
    """
    try:
        from work4you_cli.model_catalog import get_curated_nous_models
...
def provider_model_ids(provider: Optional[str], *, force_refresh: bool = False) -> list[str]:
    ...
    if normalized == "nous":
        ...
        try:
            from work4you_cli.auth import fetch_nous_models, resolve_nous_runtime_credentials
            creds = resolve_nous_runtime_credentials()
            if creds:
