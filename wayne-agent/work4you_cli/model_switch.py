...
def list_authenticated_providers(
    ...
    *,
    ...
    from work4you_cli.providers import WAYNE_OVERLAYS
    ...
    for pid, overlay in WAYNE_OVERLAYS.items():
        ...
        # reflects the active region (eu.*, ap.*) not the static us.* list.
            ...
            try:
                ...
                from work4you_cli.auth import get_provider_auth_state as _nous_state
    ...
    if user_providers and isinstance(user_providers, dict):
        for ep_name, ep_cfg in user_providers.items():
            ...
            # (see work4you_cli/main.py::_save_custom_provider); older
