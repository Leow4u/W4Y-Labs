...
Usage:
    wayne pairing list              # Show all pending + approved users
    wayne pairing approve <platform> <code>  # Approve a pairing code
    wayne pairing revoke <platform> <user_id> # Revoke user access
...
def pairing_command(args):
    ...
    if action == "list":
        ...
        print("Usage: wayne pairing {list|approve|revoke|clear-pending}")
        print("Run 'wayne pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'wayne pairing list' to see pending codes.\n")
