...
def _model_flow_nous(config, current_model="", args=None):
    ...
    from work4you_cli.nous_subscription import prompt_enable_tool_gateway
    ...
    if free_tier and not model_ids:
        ...
        if unavailable_models:
            from work4you_cli.auth import DEFAULT_NOUS_PORTAL_URL
...
def _model_flow_custom(config):
    ...
    from work4you_cli.auth import _save_model_choice, deactivate_provider
    from work4you_cli.config import get_env_value, load_config, save_config
