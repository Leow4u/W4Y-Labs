    ...
    for wrapper in wrapper_paths:
        if wrapper.exists():
            try:
                ...
                if 'work4you_cli' in content or 'wayne-agent' in content:
                    wrapper.unlink()
...
def _uninstall_profile(profile) -> None:
    ...
    #    Use `python -m work4you_cli.main` so we don't depend on a `wayne`
    #    wrapper that may be half-removed mid-uninstall.
    wayne_invocation = [_sys.executable, "-m", "work4you_cli.main", "--profile", name]
