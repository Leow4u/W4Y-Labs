...
from work4you_constants import display_wayne_home, is_termux as _is_termux_environment
...
class CLICommandsMixin:
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to work4you_cli.curator so the CLI and the `wayne curator`
