"""wayne webhook — manage dynamic webhook subscriptions from the CLI.

Usage:
    wayne webhook subscribe <name> [options]
    wayne webhook list
    wayne webhook remove <name>
    wayne webhook test <name> [--payload '{"key": "value"}']

Subscriptions persist to ~/.wayne/webhook_subscriptions.json and are
...
def _subscriptions_path() -> Path:
    return _wayne_home() / _SUBSCRIPTIONS_FILENAME
...
def webhook_command(args):
    """Entry point for 'wayne webhook' subcommand."""
