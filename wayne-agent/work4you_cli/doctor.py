...
from work4you_cli.config import get_project_root, get_wayne_home, get_env_path
...
from work4you_cli.models import _WAYNE_USER_AGENT
...
def run_doctor(args):
    ...
    if soul_path.exists():
        ...
        if should_fix:
            from work4you_cli.default_soul import DOCTOR_SCAFFOLD_SOUL_MD
