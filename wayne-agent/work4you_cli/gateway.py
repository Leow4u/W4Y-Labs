...
# when work4you_constants is cached from a pre-update version during `wayne update`.
...
_LEGACY_UNIT_EXECSTART_MARKERS: tuple[str, ...] = (
    # Deliberately the OLD module path: these markers identify units created
    # BEFORE the work4you_cli package rename. New units are never legacy.
...
def generate_launchd_plist() -> str:
    ...
    prog_args = [
        ...
        "<string>-m</string>",
        "<string>work4you_cli.main</string>",
    ]
    if profile_arg:
