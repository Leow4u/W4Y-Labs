 ...
 *
 * Plugins call window.__WAYNE_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__WAYNE_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__WAYNE_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__WAYNE_PLUGIN_SDK__ = {
    ...
    // window.__WAYNE_SESSION_TOKEN__ directly.
    authedFetch,
