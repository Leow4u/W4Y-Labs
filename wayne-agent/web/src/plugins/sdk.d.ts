/**
 * Wayne Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__WAYNE_PLUGIN_SDK__`` and
 * ``window.__WAYNE_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__WAYNE_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``WaynePluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@wayne/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__WAYNE_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__WAYNE_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__WAYNE_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface WaynePluginSDK {
...
declare global {
  interface Window {
    __WAYNE_PLUGIN_SDK__?: WaynePluginSDK;
    __WAYNE_PLUGINS__?: PluginRegistry;
  }
}
