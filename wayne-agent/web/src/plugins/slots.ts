 ...
 * `window.__WAYNE_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Wayne brand in the top bar
 ...
 *  `window.__WAYNE_PLUGINS__.registerSlot(...)`.
 *
