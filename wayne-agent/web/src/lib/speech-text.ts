/** Strip markdown/formatting so TTS doesn't read "**bold**" or code fences
 *  literally — ported from the desktop's voice-conversation mode
 *  (apps/desktop/src/lib/speech-text.ts), same regex set, same behavior. */
