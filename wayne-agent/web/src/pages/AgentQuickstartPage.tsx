        ...
        <>
          ...
          >
            ...
            <div className="min-h-0 flex-1 overflow-y-auto px-5 pb-6">
              {/* Uma coluna sempre. Este painel é um trilho estreito de largura
                  fixa; dividi-lo em duas colunas no `xl` dava ~170px por cartão
                  e cortava o nome do modelo no meio da palavra — e piorava
                  quanto MAIOR o monitor, que é o oposto do que se espera. */}
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        {/* Quebra em duas linhas em vez de cortar: o nome do
                            modelo é o que o dono usa pra escolher, então cortá-lo
                            ("Esquadrão de Marke…") tira justamente a informação
                            que faz o cartão existir. */}
                        <span className="min-w-0 flex-1 line-clamp-2 text-sm font-semibold text-foreground">
                          {tpl.draft.name}
                        </span>
