...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateWayne: "Wayne frissítése",
    updatingWayne: "Wayne frissítése…",
  ...
  chat: {
    ...
    disclaimer: "Wayne hibázhat. Ellenőrizd a fontos információkat.",
    tasks: "Feladatok",
    ...
    journeyEmpty: "Wayne még nem tanult itt semmit.",
    ...
    previewMobile: "Mobil",
    previewEmptyHint: "Válassz egy .html fájlt a Fájlok fülön — a Wayne által készített oldalak maguktól megjelennek itt.",
    ...
    notifyAsk: "Szeretnél értesítést kapni, amikor Wayne válaszol?",
    notifyEnable: "Értesítsen",
    notifyDone: "Kész — nézd meg.",
    notifyNeedsYouBody: "Wayne rád vár — jóváhagyás vagy válasz szükséges.",
    toolsOne: "eszköz",
    ...
    attachUrl: "URL…",
    steerPlaceholder: "Irányítsd Wayne-t munka közben…",
  ...
  agents: {
    ...
    qsHint: "Írd le egy mondatban — Wayne elkészíti a konfigurációt, te csak átnézed.",
    ...
    qsRoutine: "Rutin",
    qsRoutineHint: "Az ügynök magától, időzítve dolgozik — a naptára készen születik.",
    qsRoutineAdd: "Rutin hozzáadása",
    qsRoutineRemove: "Eltávolítás",
    qsRoutinePrompt: "Mit tesz, amikor a rutin elindul…",
    presetDaily9: "Minden nap 9-kor",
    presetWeekdays8: "Hétköznap 8-kor",
    presetWeeklyMon9: "Hétfőnként 9-kor",
    ...
    eqMcpHint: "Külső kapcsolatok (MCP), amiket ez az ügynök használhat.",
    eqMcpNone: "Nincs MCP szerver ehhez az ügynökhöz.",
    eqActivityHint: "Az ügynök legutóbbi munkamenetei.",
    ...
    wfHint: "Hogyan dolgozik ez a munkatárs, elejétől a végéig — kattints egy blokkra a megnyitáshoz és beállításhoz.",
    opsTab: "Műveletek",
    opsHint: "A csapat feladattáblája. Hozz létre feladatot, válaszd ki ki futtatja, és indítsd — az ügynök egyedül dolgozik és hozza az eredményt átnézésre.",
    opsNewTask: "Új feladat",
    opsNewTaskHint: "Írd le, mit kell csinálni és ki csinálja.",
    opsTaskTitle: "Cím",
    ...
    govTab: "Irányítás",
    govHint: "A tulajdonos nézete: mennyibe kerül minden ügynök, mennyit fut és mennyi az autonómiája.",
    ...
    eqCanvasHint: "A csapatod egy élő térképen — kattints egy ügynökre a röntgenképéhez; húzd az elrendezéshez.",
    eqTabProfile: "Profil",
    eqTalk: "Beszélgetés",
    eqCost30d: "Költség · 30 nap",
    eqSessions: "Munkamenetek · 30 nap",
    eqDefaultNote: "Ez a Wayne fő ügynöke — nem távolítható el.",
    ...
    eqSkillsHint: "Amit ez az ügynök tud. Kapcsold ki, ami nem illik a szerepéhez.",
    eqSkillsActive: "{on} / {total} aktív",
    eqChannelsHint: "Ahol ez az ügynök a világgal beszél.",
    ...
    templatesHint: "Egy kattintás, és csatlakozik a csapatodhoz.",
  ...
  pluginsPage: {
    ...
    headline:
      "Wayne-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `wayne plugins` paritás).",
  ...
  env: {
    ...
    customHint: "A .env fájlban tárolt tetszőleges környezeti változók, amelyeket a Wayne nem ismer fel. Használd ezeket környezeti változók beillesztésére képességekhez, MCP-kiszolgálókhoz vagy saját eszközeidhez.",
  ...
  configUser: {
    ...
    memoryNotifHint: "Megjelenít egy 'Memória frissítve' sort a csevegésben, amikor a Wayne új dolgot ment rólad.",
    instructions: "Egyéni utasítások",
    instructionsHint: "Mondd el a Wayne-nek, hogyan szeretnéd, hogy bánjanak veled, és mit tudjon rólad — név, foglalkozás, hangnem. Minden beszélgetésben használja.",
    ...
    defaultTier: "Wayne alapértelmezett módja",
    ...
    notifyTurnDoneHint: "Szól, ha Wayne befejez egy feladatot, míg a lap a háttérben van.",
    notifyNeedsYou: "Szüksége van rád",
    notifyNeedsYouHint: "Szól, ha Wayne jóváhagyást vagy választ kér.",
    memoryBudget: "Memória mérete",
    memoryBudgetHint: "Mennyi kontextust őriz meg Wayne a munkamenetek között.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető Wayne-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "Wayne munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a Wayne kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A Wayne egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
