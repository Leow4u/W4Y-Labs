...
export const tr: Translations = {
  ...
  agents: {
    ...
    qsHint: "Tek cümleyle anlatın — Wayne yapılandırmayı hazırlar, siz gözden geçirirsiniz.",
    ...
    qsRoutine: "Rutin",
    qsRoutineHint: "Ajan zamanında kendi başına çalışır — ajandası doğuştan ayarlı gelir.",
    qsRoutineAdd: "Rutin ekle",
    qsRoutineRemove: "Kaldır",
    qsRoutinePrompt: "Rutin tetiklendiğinde ne yapar…",
    presetDaily9: "Her gün 09.00",
    presetWeekdays8: "Hafta içi 08.00",
    presetWeeklyMon9: "Pazartesileri 09.00",
    ...
    eqMcpHint: "Bu ajanın kullanabileceği dış bağlantılar (MCP).",
    eqMcpNone: "Bu ajan için yapılandırılmış MCP sunucusu yok.",
    eqActivityHint: "Bu ajanın son oturumları.",
    ...
    wfServers: "{n} sunucu",
    wfResults: "Sonuçlar",
    wfHint: "Bu çalışanın uçtan uca nasıl çalıştığı — açmak ve ayarlamak için bir bloğa tıkla.",
    opsTab: "Operasyonlar",
    opsHint: "Ekibin görev panosu. Görev oluştur, kimin çalıştıracağını seç ve gönder — ajan kendi başına çalışır ve sonucu incelemene getirir.",
    opsNewTask: "Yeni görev",
    opsNewTaskHint: "Ne yapılacağını ve kimin yapacağını tarif et.",
    opsTaskTitle: "Başlık",
    ...
    govTab: "Yönetişim",
    govHint: "Sahibin bakışı: her ajan ne kadara mal oluyor, ne kadar çalışıyor ve ne kadar özerk.",
    ...
    eqCanvasHint: "Ekibin canlı bir haritada — röntgenini açmak için bir ajana tıkla; düzenlemek için sürükle.",
    eqTabProfile: "Profil",
    eqTalk: "Sohbet",
    ...
    eqSkillsHint: "Bu ajanın yapabildikleri. Rolüne uymayanları kapat.",
    eqSkillsActive: "{total} beceriden {on} etkin",
    eqChannelsHint: "Bu ajanın dünyayla konuştuğu yerler.",
    ...
    templatesHint: "Tek tıkla ekibinize katılır.",
