...
export interface Translations {
  ...
  channels: {
    ...
    advancedOptions: string;
    fld_allowAll: string;
    fld_allowedUsers: string;
    fld_allowedUsersHint: string;
    fld_homeName: string;
    fld_homeChannel: string;
    fld_homeChannelHint: string;
    fld_homeAddress: string;
    fld_botToken: string;
    fld_botTokenHint: string;
    fld_accessToken: string;
    fld_appToken: string;
    fld_apiKey: string;
    fld_signingSecret: string;
    fld_phoneNumberId: string;
    fld_imapHost: string;
    fld_imapHostHint: string;
    fld_smtpHost: string;
    fld_smtpHostHint: string;
    fld_smtpPort: string;
    fld_imapPort: string;
    fld_password: string;
    fld_passwordHint: string;
    fld_address: string;
    fld_webhookUrl: string;
    fld_proxy: string;
    fld_enabled: string;
    fld_mode: string;
    showLess: string;
