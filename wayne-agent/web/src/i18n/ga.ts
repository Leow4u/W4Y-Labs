...
export const ga: Translations = {
  ...
  status: {
    ...
    stopped: "Stoptha",
    updateWayne: "Nuashonraigh Wayne",
    updatingWayne: "Ag nuashonrú Wayne…",
  ...
  chat: {
    ...
    disclaimer: "Is féidir le Wayne botúin a dhéanamh. Seiceáil eolas tábhachtach.",
    tasks: "Tascanna",
    newTask: "Seisiún nua",
    ...
    journeyEmpty: "Níl aon rud foghlamtha ag Wayne anseo fós.",
    journeySkill: "Scil",
    ...
    previewMobile: "Fón",
    previewEmptyHint: "Roghnaigh comhad .html sa táb Comhaid — taispeánfar leathanaigh a ghineann Wayne anseo leo féin.",
    ...
    notifyAsk: "Ar mhaith leat fógra a fháil nuair a fhreagraíonn Wayne?",
    notifyEnable: "Cuir fógra chugam",
    notifyDone: "Críochnaithe — tar chun féachaint.",
    notifyNeedsYouBody: "Tá Wayne ag fanacht leat — tá ceadú nó freagra ag teastáil.",
    toolsOne: "uirlis",
    ...
    attachUrl: "URL…",
    steerPlaceholder: "Treoraigh Wayne agus é ag obair…",
  ...
  agents: {
    ...
    qsHint: "Déan cur síos air in abairt amháin — ullmhóidh Wayne an chumraíocht le hathbhreithniú.",
    ...
    qsRoutine: "Gnáthamh",
    qsRoutineHint: "Oibríonn an gníomhaire leis féin, ar sceideal — saolaítear a chlár ama cumraithe.",
    qsRoutineAdd: "Cuir gnáthamh leis",
    qsRoutineRemove: "Bain",
    qsRoutinePrompt: "Cad a dhéanann sé nuair a thosaíonn an gnáthamh…",
    presetDaily9: "Gach lá ar 9rn",
    presetWeekdays8: "Laethanta oibre ar 8rn",
    presetWeeklyMon9: "Dé Luain ar 9rn",
    ...
    eqMcpHint: "Naisc sheachtracha (MCP) is féidir leis an ngníomhaire seo a úsáid.",
    eqMcpNone: "Níl aon fhreastalaí MCP cumraithe don ghníomhaire seo.",
    eqActivityHint: "Seisiúin is déanaí an ghníomhaire seo.",
    ...
    wfResults: "Torthaí",
    wfHint: "Conas a oibríonn an fostaí seo, ó thús deireadh — cliceáil ar bhloc chun é a oscailt agus a choigeartú.",
    opsTab: "Oibríochtaí",
    opsHint: "Clár tascanna na foirne. Cruthaigh tasc, roghnaigh cé a ritheann é agus seol — oibríonn an gníomhaire leis féin agus tugann sé an toradh ar ais le hathbhreithniú.",
    opsNewTask: "Tasc nua",
    opsNewTaskHint: "Déan cur síos ar cad atá le déanamh agus cé a dhéanann é.",
    ...
    govTab: "Rialachas",
    govHint: "Radharc an úinéara: cé mhéad a chosnaíonn gach gníomhaire, cé mhéad a ritheann sé agus cé mhéad neamhspleáchais atá aige.",
    ...
    eqCanvasHint: "Do fhoireann ar léarscáil bheo — cliceáil ar ghníomhaire chun a x-gha a oscailt; tarraing chun eagrú.",
    eqTabProfile: "Próifíl",
    eqTalk: "Comhrá",
    eqCost30d: "Costas · 30 lá",
    eqSessions: "Seisiúin · 30 lá",
    eqDefaultNote: "Seo príomhghníomhaire do Wayne — ní féidir é a bhaint.",
    ...
    eqSkillsHint: "Cad is féidir leis an ngníomhaire seo a dhéanamh. Múch an méid nach n-oireann dá ról.",
    eqSkillsActive: "{on} as {total} gníomhach",
    eqChannelsHint: "Cá labhraíonn an gníomhaire seo leis an domhan.",
    ...
    templatesHint: "Cliceáil amháin agus tá sé ar d'fhoireann.",
  ...
  pluginsPage: {
    ...
    headline:
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins Wayne (paireacht le `wayne plugins`).",
  ...
  env: {
    ...
    customHint: "Athróga timpeallachta treallach atá stóráilte i do .env nach n-aithníonn Wayne. Úsáid iad chun athróga timpeallachta a instealladh do scileanna, freastalaithe MCP, nó d'uirlisí féin.",
  ...
  configUser: {
    ...
    memoryNotifHint: "Taispeánann sé líne 'Cuimhne nuashonraithe' sa chomhrá nuair a shábhálann Wayne rud nua fút.",
    instructions: "Treoracha saincheaptha",
    instructionsHint: "Inis do do Wayne conas ba mhaith leat go gcaithfí leat agus cad ba chóir dó a bheith ar eolas fút — ainm, gairm, ton. Úsáideann sé é seo i ngach comhrá.",
    ...
    defaultTier: "Mód réamhshocraithe Wayne",
    ...
    notifyTurnDoneHint: "Cuireann sé in iúl duit nuair a chríochnaíonn Wayne tasc agus an cluaisín sa chúlra.",
    notifyNeedsYou: "Tá tú ag teastáil",
    notifyNeedsYouHint: "Cuireann sé in iúl duit nuair a iarrann Wayne ceadú nó freagra.",
    memoryBudget: "Méid na cuimhne",
    memoryBudgetHint: "Cé mhéad comhthéacs a choinníonn Wayne idir seisiúin.",
    budgetCompact: "Dlúth",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Suaitheantais Wayne inbhailithe a thuilltear ó stair fíor-session. Léirítear gnóthachtálacha aitheanta neamhchríochnaithe mar Discovered; fanann gnóthachtálacha Secret i bhfolach go dtí go bhfeictear an chéad iompar comhoiriúnach.",
      scan_subtitle:
        "Stair session Wayne á scanadh. Is féidir leis an gcéad scan 5–10 soicind a thógáil ar staireanna móra.",
    },
    actions: {
      rescan: "Athscan",
    },
    stats: {
      ...
      latest_hint_empty: "rith Wayne níos mó",
    ...
    guide: {
      ...
      secret_body:
        "Coinníonn rúin a dtruicear cruinn faoi cheilt. Nuair a fheiceann Wayne comhartha gaolmhar, athraíonn an cárta go Aimsithe agus taispeánann sé a riachtanas.",
      scan_status_header: "Stádas an scanta",
      scan_status_body:
        "Scanann Wayne an stair logánta uair amháin, ansin feicfear cártaí go huathoibríoch. Níl aon rud sáinnithe má thógann sé cúpla soicind.",
