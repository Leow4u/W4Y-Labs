...
export const ja: Translations = {
  ...
  status: {
    ...
    stopped: "停止",
    updateWayne: "Wayne を更新",
    updatingWayne: "Wayne を更新しています…",
  ...
  chat: {
    ...
    working: "処理中…",
    thinking: "考え中",
    disclaimer: "Wayne は間違えることがあります。重要な情報はご確認ください。",
    tasks: "タスク",
    newTask: "新しいセッション",
    ...
    reconnecting: "再接続中…",
    journeyTitle: "学習の歩み",
    journeyEmpty: "Wayne はまだ何も学んでいません。",
    journeySkill: "スキル",
    journeyMemory: "メモリー",
    ...
    previewMobile: "モバイル",
    previewEmptyHint: "ファイルタブで .html を選択してください — Wayne が生成したページは自動でここに表示されます。",
    gitShip: "コミットまたは送信",
    gitCommit: "コミット",
    ...
    notifyAsk: "Wayne の返信時に通知を受け取りますか？",
    notifyEnable: "通知する",
    notifyDone: "完了しました — ご確認ください。",
    notifyNeedsYouBody: "Wayne があなたを待っています — 承認または返答が必要です。",
    toolsOne: "個のツール",
    workedFor: "{t} 作業しました",
    detailsLabel: "作業の詳細",
    detailHidden: "非表示",
    ...
    pasteImage: "画像を貼り付け",
    attachUrl: "URL…",
    steerPlaceholder: "作業中の Wayne に指示を出す…",
  ...
  agents: {
    ...
    qsHint: "一文で説明してください — Wayne が設定案を作り、あなたが確認します。",
    ...
    wfServers: "{n}台のサーバー",
    wfResults: "結果",
    wfHint: "この社員の働き方を端から端まで — ブロックをクリックして開いて調整。",
    opsTab: "オペレーション",
    opsHint: "チームのタスクボード。タスクを作成し、実行者を選んで送り出す — エージェントは自分で働き、結果をレビューに持ってきます。",
    opsNewTask: "新しいタスク",
    opsNewTaskHint: "何をするか、誰がやるかを記述。",
    opsTaskTitle: "タイトル",
    ...
    govTab: "ガバナンス",
    govHint: "オーナーの視点：各エージェントのコスト、稼働量、自律性。",
    ...
    eqCanvasHint: "チームを生きたマップで — エージェントをクリックしてレントゲンを開き、ドラッグで整理。",
    eqTabProfile: "プロフィール",
    eqTalk: "チャット",
    eqCost30d: "コスト · 30日",
    eqSessions: "セッション · 30日",
    eqDefaultNote: "これはWayneのメインエージェントです — 削除できません。",
  ...
  pluginsPage: {
    ...
    headline:
      "Wayne プラグインを発見、インストール、有効化、更新します (`wayne plugins` 相当)。",
  ...
  env: {
    ...
    hideValue: "値を非表示",
    customTitle: "カスタムキー",
    customHint: "Wayne が認識しない、.env に保存された任意の環境変数。スキル、MCP サーバー、または独自のツール用に環境変数を注入するために使用します。",
  ...
  configUser: {
    ...
    memoryNotifHint: "Wayne があなたについて新しいことを保存したとき、チャットに「メモリーを更新しました」の行を表示します。",
    instructions: "カスタム指示",
    instructionsHint: "あなたがどう扱われたいか、Wayne が何を知っておくべきか（名前・職業・トーン）を伝えてください。すべての会話で使われます。",
    ...
    notifyTurnDone: "応答完了",
    notifyTurnDoneHint: "タブがバックグラウンドのときに Wayne がタスクを終えると通知します。",
    notifyNeedsYou: "あなたの確認待ち",
    notifyNeedsYouHint: "Wayne が承認や返答を求めたときに通知します。",
    memoryBudget: "メモリーの容量",
    memoryBudgetHint: "セッション間で Wayne が保持するコンテキストの量。",
    budgetCompact: "コンパクト",
    budgetStandard: "標準",
    budgetAmple: "たっぷり",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "実際のセッション履歴から獲得できる Wayne のコレクタブル バッジです。既知の未達成の実績は「Discovered」として表示され、Secret 実績は最初の該当する挙動が検出されるまで非表示のままです。",
      scan_subtitle:
        "Wayne のセッション履歴をスキャンしています。履歴が大きい場合、初回スキャンには 5～10 秒かかることがあります。",
    },
    actions: {
      rescan: "再スキャン",
    },
    stats: {
      ...
      latest: "最新",
      latest_hint_empty: "Wayne をもっと使ってみてください",
      none_yet: "まだありません",
    },
    state: {
      unlocked: "解除済み",
    ...
    guide: {
      ...
      secret_body:
        "シークレットはトリガー条件を隠しています。Wayne が関連するシグナルを検出すると、カードは「Discovered」になり、要件が表示されます。",
      scan_status_header: "スキャン状況",
      scan_status_body:
        "Wayne はローカル履歴を一度スキャンし、その後カードが自動的に表示されます。数秒かかってもスタックしているわけではありません。",
