...
export const es: Translations = {
  ...
  agents: {
    ...
    qsHint: "Descríbelo en una frase: Wayne arma la configuración para que la revises.",
    ...
    qsRoutine: "Rutina",
    qsRoutineHint: "El agente trabaja solo, a la hora; su agenda nace configurada.",
    qsRoutineAdd: "Añadir rutina",
    qsRoutineRemove: "Quitar",
    qsRoutinePrompt: "Qué hace cuando la rutina se dispara…",
    presetDaily9: "Cada día a las 9",
    presetWeekdays8: "Días hábiles a las 8",
    presetWeeklyMon9: "Lunes a las 9",
    ...
    eqMcpHint: "Conexiones externas (MCP) que este agente puede usar.",
    eqMcpNone: "Ningún servidor MCP configurado para este agente.",
    eqActivityHint: "Últimas sesiones de este agente.",
    ...
    wfHint: "Cómo trabaja este empleado, de punta a punta — haz clic en un bloque para abrirlo y ajustarlo.",
    opsTab: "Operaciones",
    opsHint: "El tablero de tareas del equipo. Crea una tarea, elige quién la ejecuta y despacha — el agente trabaja solo y trae el resultado para tu revisión.",
    opsNewTask: "Nueva tarea",
    opsNewTaskHint: "Describe qué hay que hacer y quién lo hace.",
    opsTaskTitle: "Título",
    ...
    govTab: "Gobernanza",
    govHint: "La visión del dueño: cuánto cuesta cada agente, cuánto corre y cuánta autonomía tiene.",
    ...
    eqCanvasHint: "Tu equipo en un mapa vivo — haz clic en un agente para abrir su radiografía; arrastra para organizar.",
    eqTabProfile: "Perfil",
    eqTalk: "Conversar",
    ...
    eqSkillsHint: "Lo que este agente sabe hacer. Desactiva lo que no encaje con su función.",
    eqSkillsActive: "{on} de {total} activas",
    eqChannelsHint: "Por dónde este agente habla con el mundo.",
    ...
    templatesHint: "Un clic y se une a tu equipo.",
