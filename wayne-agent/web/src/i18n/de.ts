...
export const de: Translations = {
  ...
  agents: {
    ...
    eqMcpHint: "Externe Verbindungen (MCP), die dieser Agent nutzen kann.",
    eqMcpNone: "Keine MCP-Server für diesen Agenten konfiguriert.",
    eqActivityHint: "Letzte Sitzungen dieses Agenten.",
    ...
    wfHint: "Wie dieser Mitarbeiter arbeitet, von Anfang bis Ende — klicke auf einen Block, um ihn zu öffnen und anzupassen.",
    opsTab: "Betrieb",
    opsHint: "Das Aufgabenboard des Teams. Erstelle eine Aufgabe, wähle wer sie ausführt und schicke sie los — der Agent arbeitet allein und bringt das Ergebnis zur Prüfung.",
    opsNewTask: "Neue Aufgabe",
    opsNewTaskHint: "Beschreibe, was zu tun ist und wer es macht.",
    opsTaskTitle: "Titel",
    ...
    govTab: "Governance",
    govHint: "Die Eigentümer-Sicht: was jeder Agent kostet, wie viel er läuft und wie viel Autonomie er hat.",
