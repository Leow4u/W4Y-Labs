...
export const ko: Translations = {
  ...
  status: {
    ...
    stopped: "중지됨",
    updateWayne: "Wayne 업데이트",
    updatingWayne: "Wayne 업데이트 중…",
  ...
  chat: {
    ...
    working: "처리 중…",
    thinking: "생각 중",
    disclaimer: "Wayne도 실수할 수 있어요. 중요한 정보는 확인해 주세요.",
    tasks: "작업",
    newTask: "새 세션",
    ...
    journeyTitle: "학습 여정",
    journeyEmpty: "Wayne이 아직 아무것도 배우지 않았어요.",
    journeySkill: "스킬",
    journeyMemory: "메모리",
    ...
    previewDesktop: "데스크톱",
    previewMobile: "모바일",
    previewEmptyHint: "파일 탭에서 .html 파일을 선택하세요 — Wayne이 만든 페이지는 자동으로 여기에 나타납니다.",
    gitShip: "커밋 또는 전송",
    gitCommit: "커밋",
    ...
    notifyAsk: "Wayne이 응답하면 알림을 받으시겠어요?",
    notifyEnable: "알림 받기",
    notifyDone: "완료했어요 — 확인해 보세요.",
    notifyNeedsYouBody: "Wayne이 기다리고 있습니다 — 승인 또는 답변이 필요합니다.",
    toolsOne: "개 도구",
    workedFor: "{t} 동안 작업함",
    ...
    pasteImage: "이미지 붙여넣기",
    attachUrl: "URL…",
    steerPlaceholder: "작업 중인 Wayne에게 지시하세요…",
  ...
  agents: {
    ...
    teamTab: "팀",
    qsTitle: "어떤 직원을 만들까요?",
    qsHint: "한 문장으로 설명하세요 — Wayne이 구성을 만들어 드리고, 검토만 하면 됩니다.",
    ...
    qsRoutine: "루틴",
    qsRoutineHint: "에이전트가 정해진 시간에 스스로 일합니다 — 일정이 처음부터 설정됩니다.",
    qsRoutineAdd: "루틴 추가",
    qsRoutineRemove: "제거",
    qsRoutinePrompt: "루틴이 실행될 때 할 일…",
    presetDaily9: "매일 오전 9시",
    presetWeekdays8: "평일 오전 8시",
    presetWeeklyMon9: "매주 월요일 오전 9시",
    qsCreate: "이 에이전트 만들기",
    qsRefine: "계속 다듬기",
    qsRefinePlaceholder: "무엇을 조정할까요? 예: 더 격식 있는 어조, 더 강력한 모델",
    qsCreated: "에이전트가 생성되었습니다",
    eqTabActivity: "활동",
    eqMcpHint: "이 에이전트가 사용할 수 있는 외부 연결(MCP).",
    eqMcpNone: "이 에이전트에 구성된 MCP 서버가 없습니다.",
    eqActivityHint: "이 에이전트의 최근 세션.",
    ...
    wfServers: "서버 {n}개",
    wfResults: "결과",
    wfHint: "이 직원이 일하는 방식을 처음부터 끝까지 — 블록을 클릭해 열고 조정하세요.",
    opsTab: "운영",
    opsHint: "팀의 작업 보드. 작업을 만들고 실행할 에이전트를 골라 보내세요 — 에이전트가 스스로 일하고 결과를 검토용으로 가져옵니다.",
    opsNewTask: "새 작업",
    opsNewTaskHint: "무엇을 할지, 누가 할지 설명하세요.",
    opsTaskTitle: "제목",
    ...
    govTab: "거버넌스",
    govHint: "오너의 시각: 각 에이전트의 비용, 가동량, 자율성.",
    ...
    tplExpand: "기성 템플릿 보기",
    eqCanvasHint: "살아있는 지도 위의 팀 — 에이전트를 클릭해 엑스레이를 열고, 드래그로 정리하세요.",
    eqTabProfile: "프로필",
    eqTalk: "채팅",
    eqCost30d: "비용 · 30일",
    eqSessions: "세션 · 30일",
    eqDefaultNote: "Wayne의 메인 에이전트입니다 — 삭제할 수 없습니다.",
    ...
    eqSkillsHint: "이 에이전트가 할 수 있는 일. 역할에 맞지 않으면 끄세요.",
    eqSkillsActive: "{total}개 중 {on}개 활성",
    eqChannelsHint: "이 에이전트가 세상과 대화하는 곳.",
    eqChannelsNone: "아직 연결된 채널이 없습니다.",
    eqChannelsManage: "채널 관리",
    qsStartOver: "처음부터 다시",
    templatesTitle: "템플릿으로 시작",
    templatesHint: "클릭 한 번이면 팀에 합류합니다.",
    recurringBadge: "반복",
    premiumBadge: "Pro",
  ...
  pluginsPage: {
    ...
    headline:
      "Wayne 플러그인을 검색, 설치, 활성화 및 업데이트합니다 (`wayne plugins` 동등).",
  ...
  env: {
    ...
    customHint: "Wayne가 인식하지 못하는, .env에 저장된 임의의 환경 변수입니다. 스킬, MCP 서버 또는 자체 도구를 위한 환경 변수를 주입하는 데 사용하세요.",
  ...
  configUser: {
    ...
    memoryNotifHint: "Wayne이 당신에 대해 새로운 것을 저장하면 채팅에 '메모리 업데이트됨' 줄을 표시합니다.",
    instructions: "맞춤 지침",
    instructionsHint: "Wayne에게 어떻게 대해지고 싶은지, 무엇을 알아야 하는지 알려주세요 — 이름, 직업, 말투. 모든 대화에서 사용됩니다.",
    ...
    notifyTurnDoneHint: "탭이 백그라운드일 때 Wayne이 작업을 마치면 알립니다.",
    notifyNeedsYou: "확인 필요",
    notifyNeedsYouHint: "Wayne이 승인이나 답변을 요청하면 알립니다.",
    memoryBudget: "메모리 크기",
    memoryBudgetHint: "세션 간에 Wayne이 유지하는 컨텍스트 양.",
    budgetCompact: "컴팩트",
    budgetStandard: "표준",
    budgetAmple: "넉넉하게",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "실제 세션 기록에서 획득하는 Wayne 컬렉터블 배지입니다. 알려져 있지만 아직 달성되지 않은 업적은 Discovered로 표시되며, Secret 업적은 일치하는 동작이 처음 나타날 때까지 숨겨집니다.",
      scan_subtitle:
        "Wayne 세션 기록을 스캔하고 있습니다. 기록이 많으면 첫 스캔에 5~10초가 걸릴 수 있습니다.",
    },
    actions: {
      rescan: "다시 스캔",
    },
    stats: {
      ...
      latest: "최근",
      latest_hint_empty: "Wayne를 더 사용해 보세요",
      none_yet: "아직 없음",
    },
    state: {
      unlocked: "해제됨",
    ...
    guide: {
      ...
      secret_body:
        "시크릿은 정확한 트리거 조건을 숨깁니다. Wayne가 관련 신호를 감지하면 카드가 Discovered로 바뀌고 요건이 표시됩니다.",
      scan_status_header: "스캔 상태",
      scan_status_body:
        "Wayne는 로컬 기록을 한 번 스캔한 뒤 카드를 자동으로 표시합니다. 몇 초 걸리더라도 멈춘 것이 아닙니다.",
