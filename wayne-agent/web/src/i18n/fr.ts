...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateWayne: "Mettre à jour Wayne",
    updatingWayne: "Mise à jour de Wayne…",
  ...
  chat: {
    ...
    working: "En cours…",
    thinking: "Réflexion",
    disclaimer: "Wayne peut faire des erreurs. Vérifiez les informations importantes.",
    tasks: "Tâches",
    ...
    journeyEmpty: "Wayne n'a encore rien appris ici.",
    ...
    previewEmptyHint: "Choisissez un fichier .html dans Fichiers — les pages générées par Wayne apparaissent ici d'elles-mêmes.",
    ...
    notifyAsk: "Être averti quand Wayne répond ?",
    notifyEnable: "M'avertir",
    notifyDone: "Terminé — venez voir.",
    notifyNeedsYouBody: "Wayne vous attend — une approbation ou une réponse est nécessaire.",
    toolsOne: "outil",
    ...
    attachUrl: "URL…",
    steerPlaceholder: "Guidez Wayne pendant qu'il travaille…",
  ...
  agents: {
    ...
    qsHint: "Décrivez-le en une phrase — Wayne prépare la configuration à réviser.",
    ...
    qsRoutine: "Routine",
    qsRoutineHint: "L'agent travaille seul, à l'heure — son agenda naît configuré.",
    qsRoutineAdd: "Ajouter une routine",
    qsRoutineRemove: "Retirer",
    qsRoutinePrompt: "Ce qu'il fait quand la routine se déclenche…",
    presetDaily9: "Tous les jours à 9h",
    presetWeekdays8: "Jours ouvrés à 8h",
    presetWeeklyMon9: "Le lundi à 9h",
    ...
    eqMcpHint: "Connexions externes (MCP) que cet agent peut utiliser.",
    eqMcpNone: "Aucun serveur MCP configuré pour cet agent.",
    eqActivityHint: "Dernières sessions de cet agent.",
    ...
    wfResults: "Résultats",
    wfHint: "Comment cet employé travaille, de bout en bout — cliquez sur un bloc pour l'ouvrir et l'ajuster.",
    opsTab: "Opérations",
    opsHint: "Le tableau de tâches de l'équipe. Créez une tâche, choisissez qui l'exécute et lancez — l'agent travaille seul et rapporte le résultat pour votre revue.",
    opsNewTask: "Nouvelle tâche",
    opsNewTaskHint: "Décrivez ce qu'il faut faire et qui le fait.",
    opsTaskTitle: "Titre",
    ...
    govTab: "Gouvernance",
    govHint: "La vue du propriétaire : combien coûte chaque agent, combien il tourne et quelle autonomie il a.",
    ...
    eqCanvasHint: "Votre équipe sur une carte vivante — cliquez sur un agent pour ouvrir sa radiographie ; glissez pour organiser.",
    eqTabProfile: "Profil",
    eqTalk: "Discuter",
    eqCost30d: "Coût · 30 jours",
    eqSessions: "Sessions · 30 jours",
    eqDefaultNote: "C'est l'agent principal de votre Wayne — il ne peut pas être supprimé.",
    ...
    eqSkillsHint: "Ce que cet agent sait faire. Désactivez ce qui ne correspond pas à son rôle.",
    eqSkillsActive: "{on} sur {total} activées",
    eqChannelsHint: "Par où cet agent parle au monde.",
    ...
    templatesHint: "Un clic et il rejoint votre équipe.",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Wayne (parité avec `wayne plugins`).",
  ...
  env: {
    ...
    customHint: "Variables d'environnement arbitraires stockées dans votre .env que Wayne ne reconnaît pas. Utilisez-les pour injecter des variables d'environnement pour des compétences, des serveurs MCP ou vos propres outils.",
  ...
  configUser: {
    ...
    memoryNotifHint: "Affiche une ligne « Mémoire mise à jour » dans le chat quand Wayne enregistre du nouveau à votre sujet.",
    instructions: "Instructions personnalisées",
    instructionsHint: "Dites à votre Wayne comment vous souhaitez être traité et ce qu'il doit savoir sur vous — nom, métier, ton. Il l'utilise dans chaque conversation.",
    ...
    defaultTier: "Mode par défaut de Wayne",
    ...
    notifyTurnDoneHint: "Vous prévient quand Wayne termine une tâche avec l'onglet en arrière-plan.",
    notifyNeedsYou: "Besoin de vous",
    notifyNeedsYouHint: "Vous prévient quand Wayne demande une approbation ou une réponse.",
    memoryBudget: "Taille de la mémoire",
    memoryBudgetHint: "La quantité de contexte que Wayne conserve entre les sessions.",
    budgetCompact: "Compacte",
    budgetStandard: "Standard",
    budgetAmple: "Étendue",
    writeApproval: "Approuver les nouvelles mémoires",
    writeApprovalHint: "Wayne demande votre confirmation avant d'enregistrer quoi que ce soit de nouveau.",
    skills: "Compétences",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badges Wayne à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Wayne en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Wayne davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Wayne détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Wayne analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
