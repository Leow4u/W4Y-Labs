...
export const it: Translations = {
  ...
  agents: {
    ...
    qsHint: "Descrivilo in una frase — Wayne prepara la configurazione da rivedere.",
    ...
    qsRoutine: "Routine",
    qsRoutineHint: "L'agente lavora da solo, all'orario — la sua agenda nasce configurata.",
    qsRoutineAdd: "Aggiungi routine",
    qsRoutineRemove: "Rimuovi",
    qsRoutinePrompt: "Cosa fa quando la routine scatta…",
    presetDaily9: "Ogni giorno alle 9",
    presetWeekdays8: "Nei feriali alle 8",
    presetWeeklyMon9: "Lunedì alle 9",
    ...
    eqMcpHint: "Connessioni esterne (MCP) che questo agente può usare.",
    eqMcpNone: "Nessun server MCP configurato per questo agente.",
    eqActivityHint: "Ultime sessioni di questo agente.",
    ...
    wfServers: "{n} server",
    wfResults: "Risultati",
    wfHint: "Come lavora questo dipendente, da cima a fondo — clicca un blocco per aprirlo e regolarlo.",
    opsTab: "Operazioni",
    opsHint: "La bacheca delle attività del team. Crea un'attività, scegli chi la esegue e avvia — l'agente lavora da solo e porta il risultato per la tua revisione.",
    opsNewTask: "Nuova attività",
    opsNewTaskHint: "Descrivi cosa fare e chi lo fa.",
    opsTaskTitle: "Titolo",
    ...
    govTab: "Governance",
    govHint: "La visione del proprietario: quanto costa ogni agente, quanto gira e quanta autonomia ha.",
    ...
    eqCanvasHint: "La tua squadra su una mappa viva — clicca su un agente per aprire la sua radiografia; trascina per organizzare.",
    ...
    eqSkillsHint: "Cosa sa fare questo agente. Disattiva ciò che non serve al suo ruolo.",
    eqSkillsActive: "{on} di {total} attive",
    eqChannelsHint: "Dove questo agente parla con il mondo.",
    ...
    templatesHint: "Un clic ed entra nella tua squadra.",
