...
export const pt: Translations = {
  ...
  status: {
    ...
    updatingWayne: "A atualizar Wayne…",
  ...
  pluginsPage: {
    ...
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.wayne/plugins podem ser removidos.",
  ...
  achievements: {
    hero: {
      ...
      scan_subtitle:
        "A analisar o histórico de sessões do Wayne. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    },
    actions: {
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o Wayne detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
