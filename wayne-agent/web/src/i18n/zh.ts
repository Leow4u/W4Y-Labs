...
export const zh: Translations = {
  ...
  chat: {
    ...
    working: "处理中…",
    thinking: "思考中",
    disclaimer: "Wayne 可能会出错。请核对重要信息。",
    tasks: "任务",
    newTask: "新会话",
    progressTitle: "任务进度",
    stop: "停止",
    ...
    previewDesktop: "桌面",
    previewMobile: "手机",
    previewEmptyHint: "在文件标签中选择一个 .html 文件——Wayne 生成的页面会自动出现在这里。",
    gitShip: "提交或推送",
    gitCommit: "提交",
    gitCommitPush: "提交并推送",
    gitCreatePr: "创建 PR",
    ...
    notifyAsk: "Wayne 回复时要收到通知吗？",
    notifyEnable: "通知我",
    notifyDone: "完成了——来看看。",
    notifyNeedsYouBody: "Wayne 正在等您 — 需要批准或回复。",
    toolsOne: "个工具",
    workedFor: "工作了 {t}",
    detailsLabel: "工作详情",
    detailHidden: "隐藏",
    ...
    pasteImage: "粘贴图片",
    attachUrl: "URL…",
    steerPlaceholder: "在 Wayne 工作时给出指引…",
  ...
  agents: {
    ...
    qsSoul: "指令（代理的灵魂）",
    qsRoutine: "例行任务",
    qsRoutineHint: "代理按时自动工作 — 它的日程一出生就配置好了。",
    qsRoutineAdd: "添加例行任务",
    qsRoutineRemove: "移除",
    qsRoutinePrompt: "例行任务触发时它做什么…",
    presetDaily9: "每天 9 点",
    presetWeekdays8: "工作日 8 点",
    presetWeeklyMon9: "每周一 9 点",
    qsCreate: "创建此代理",
    qsRefine: "继续完善",
    qsRefinePlaceholder: "要调整什么？例如：语气更正式、模型更强",
    qsCreated: "代理已创建",
    eqTabActivity: "活动",
    eqMcpHint: "此智能体可用的外部连接（MCP）。",
    eqMcpNone: "此智能体没有配置MCP服务器。",
    eqActivityHint: "此智能体的最近会话。",
    ...
    wfServers: "{n}个服务器",
    wfResults: "结果",
    wfHint: "这位员工端到端的工作方式 — 点击一个模块打开并调整。",
    opsTab: "运营",
    opsHint: "团队的任务看板。创建任务，选择执行者并派发 — 智能体自主工作并把结果带回给你审核。",
    opsNewTask: "新任务",
    opsNewTaskHint: "描述要做什么、谁来做。",
    opsTaskTitle: "标题",
    ...
    govTab: "治理",
    govHint: "所有者视角：每个智能体的成本、运行量和自主程度。",
    ...
    tplCollapse: "折叠模板面板",
    tplExpand: "显示现成模板",
    eqCanvasHint: "你的团队在一张活地图上 — 点击智能体打开它的透视图；拖动即可排列。",
    eqTabProfile: "档案",
    eqTalk: "对话",
    eqCost30d: "成本 · 30天",
    eqSessions: "会话 · 30天",
    eqDefaultNote: "这是你的Wayne主智能体 — 无法删除。",
  ...
  pluginsPage: {
    ...
    headline: "发现、安装、启用和更新 Wayne 插件（对齐 `wayne plugins` CLI）。",
  ...
  env: {
    ...
    hideValue: "隐藏值",
    customTitle: "自定义密钥",
    customHint: "存储在 .env 中、Wayne 无法识别的任意环境变量。可用于为技能、MCP 服务器或你自己的工具注入环境变量。",
  ...
  configUser: {
    ...
    memoryNotifHint: "当 Wayne 记住关于你的新信息时，在聊天中显示一行“记忆已更新”。",
    instructions: "自定义指令",
    instructionsHint: "告诉你的 Wayne 你希望如何被对待、它该了解你什么——姓名、职业、语气。它会在每次对话中使用。",
    ...
    notifyTurnDone: "回复完成",
    notifyTurnDoneHint: "当标签页在后台且 Wayne 完成任务时提醒您。",
    notifyNeedsYou: "需要您",
    notifyNeedsYouHint: "当 Wayne 请求批准或回复时提醒您。",
    memoryBudget: "记忆容量",
    memoryBudgetHint: "Wayne 在会话之间保留多少上下文。",
    budgetCompact: "精简",
    budgetStandard: "标准",
    budgetAmple: "充足",
    writeApproval: "批准新记忆",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "从真实会话历史中获得的 Wayne 可收集徽章。已知尚未达成的成就显示为「已发现」；秘密成就在首次出现匹配行为之前保持隐藏。",
      scan_subtitle:
        "正在扫描 Wayne 会话历史。在历史记录较多时，首次扫描可能需要 5–10 秒。",
    },
    actions: {
      rescan: "重新扫描",
    },
    ...
    guide: {
      ...
      secret_header: "秘密成就",
      secret_body:
        "秘密成就会隐藏其确切触发条件。一旦 Wayne 检测到相关信号，卡片将变为「已发现」并显示其要求。",
      scan_status_header: "扫描状态",
      scan_status_body:
        "Wayne 正在对本地历史进行一次扫描，之后卡片会自动出现。即使这需要几秒钟，也没有卡住。",
