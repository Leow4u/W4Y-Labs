...
export const zhHant: Translations = {
  ...
  status: {
    ...
    stopped: "已停止",
    updateWayne: "更新 Wayne",
    updatingWayne: "正在更新 Wayne…",
  ...
  chat: {
    ...
    working: "處理中…",
    thinking: "思考中",
    disclaimer: "Wayne 可能會出錯。請核對重要資訊。",
    tasks: "任務",
    newTask: "新工作階段",
    progressTitle: "任務進度",
    stop: "停止",
    ...
    previewDesktop: "桌面",
    previewMobile: "手機",
    previewEmptyHint: "在檔案標籤中選擇一個 .html 檔案——Wayne 產生的頁面會自動出現在這裡。",
    gitShip: "提交或推送",
    gitCommit: "提交",
    gitCommitPush: "提交並推送",
    gitCreatePr: "建立 PR",
    ...
    notifyAsk: "Wayne 回覆時要收到通知嗎？",
    notifyEnable: "通知我",
    notifyDone: "完成了——來看看。",
    notifyNeedsYouBody: "Wayne 正在等您 — 需要核准或回覆。",
    toolsOne: "個工具",
    workedFor: "工作了 {t}",
    detailsLabel: "工作詳情",
    detailHidden: "隱藏",
    ...
    pasteImage: "貼上圖片",
    attachUrl: "URL…",
    steerPlaceholder: "在 Wayne 工作時給出指引…",
  ...
  agents: {
    ...
    qsSoul: "指令（代理的靈魂）",
    qsRoutine: "例行任務",
    qsRoutineHint: "代理按時自動工作 — 它的行程一出生就設定好了。",
    qsRoutineAdd: "新增例行任務",
    qsRoutineRemove: "移除",
    qsRoutinePrompt: "例行任務觸發時它做什麼…",
    presetDaily9: "每天 9 點",
    presetWeekdays8: "平日 8 點",
    presetWeeklyMon9: "每週一 9 點",
    qsCreate: "建立此代理",
    qsRefine: "繼續完善",
    qsRefinePlaceholder: "要調整什麼？例如：語氣更正式、模型更強",
    qsCreated: "代理已建立",
    eqTabActivity: "活動",
    eqMcpHint: "此智能體可用的外部連接（MCP）。",
    eqMcpNone: "此智能體沒有配置MCP伺服器。",
    eqActivityHint: "此智能體的最近工作階段。",
    ...
    wfServers: "{n}個伺服器",
    wfResults: "結果",
    wfHint: "這位員工端到端的工作方式 — 點擊一個模塊打開並調整。",
    opsTab: "運營",
    opsHint: "團隊的任務看板。創建任務，選擇執行者並派發 — 智能體自主工作並把結果帶回給你審核。",
    opsNewTask: "新任務",
    opsNewTaskHint: "描述要做什麼、誰來做。",
    opsTaskTitle: "標題",
    ...
    govTab: "治理",
    govHint: "所有者視角：每個智能體的成本、運行量和自主程度。",
    ...
    tplCollapse: "折疊模板面板",
    tplExpand: "顯示現成模板",
    eqCanvasHint: "你的團隊在一張活地圖上 — 點擊智能體打開它的透視圖；拖動即可排列。",
    eqTabProfile: "檔案",
    eqTalk: "對話",
    eqCost30d: "成本 · 30天",
    eqSessions: "工作階段 · 30天",
    eqDefaultNote: "這是你的Wayne主智能體 — 無法刪除。",
  ...
  pluginsPage: {
    ...
    headline:
      "探索、安裝、啟用並更新 Wayne 外掛（對齊 `wayne plugins` CLI）。",
  ...
  env: {
    ...
    hideValue: "隱藏值",
    customTitle: "自訂密鑰",
    customHint: "儲存在 .env 中、Wayne 無法識別的任意環境變數。可用於為技能、MCP 伺服器或你自己的工具注入環境變數。",
  ...
  configUser: {
    ...
    memoryNotifHint: "當 Wayne 記住關於你的新資訊時，在聊天中顯示一行「記憶已更新」。",
    instructions: "自訂指令",
    instructionsHint: "告訴你的 Wayne 你希望如何被對待、它該了解你什麼——姓名、職業、語氣。它會在每次對話中使用。",
    ...
    notifyTurnDone: "回覆完成",
    notifyTurnDoneHint: "當分頁在背景且 Wayne 完成任務時提醒您。",
    notifyNeedsYou: "需要您",
    notifyNeedsYouHint: "當 Wayne 請求核准或回覆時提醒您。",
    memoryBudget: "記憶容量",
    memoryBudgetHint: "Wayne 在工作階段之間保留多少脈絡。",
    budgetCompact: "精簡",
    budgetStandard: "標準",
    budgetAmple: "充足",
    writeApproval: "核准新記憶",
    writeApprovalHint: "Wayne 在寫入新記憶前會徵求您的確認。",
    skills: "技能",
    connectors: "連接器",
    plugins: "外掛",
    font: "字型",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "從真實工作階段歷史中獲得的 Wayne 可收集徽章。已知尚未達成的成就會顯示為「已發現」；秘密成就在首次出現相符行為之前保持隱藏。",
      scan_subtitle:
        "正在掃描 Wayne 工作階段歷史。在歷史紀錄較多時，首次掃描可能需要 5–10 秒。",
    },
    actions: {
      rescan: "重新掃描",
    },
    ...
    guide: {
      ...
      secret_header: "秘密成就",
      secret_body:
        "秘密成就會隱藏其確切觸發條件。一旦 Wayne 偵測到相關訊號，卡片便會變為「已發現」並顯示其需求。",
      scan_status_header: "掃描狀態",
      scan_status_body:
        "Wayne 正在對本機歷史進行一次掃描，之後卡片會自動出現。即使需要幾秒鐘，也並未卡住。",
