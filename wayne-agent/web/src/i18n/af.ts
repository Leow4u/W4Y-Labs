...
export const af: Translations = {
  ...
  agents: {
    ...
    eqMcpHint: "Eksterne verbindings (MCP) wat hierdie agent kan gebruik.",
    eqMcpNone: "Geen MCP-bedieners vir hierdie agent opgestel nie.",
    eqActivityHint: "Jongste sessies van hierdie agent.",
    ...
    wfResults: "Resultate",
    wfHint: "Hoe hierdie werknemer werk, van begin tot einde — klik op 'n blok om dit oop te maak en aan te pas.",
    opsTab: "Bedrywighede",
    opsHint: "Die span se taakbord. Skep 'n taak, kies wie dit uitvoer en stuur — die agent werk alleen en bring die resultaat vir jou hersiening.",
    opsNewTask: "Nuwe taak",
    opsNewTaskHint: "Beskryf wat gedoen moet word en wie dit doen.",
    opsTaskTitle: "Titel",
    ...
    govTab: "Bestuur",
    govHint: "Die eienaar se blik: wat elke agent kos, hoeveel dit loop en hoeveel outonomie dit het.",
