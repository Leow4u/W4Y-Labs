...
export const ru: Translations = {
  ...
  agents: {
    ...
    qsHint: "Опишите одной фразой — Wayne подготовит конфигурацию для проверки.",
    ...
    qsRoutine: "Рутина",
    qsRoutineHint: "Агент работает сам, по расписанию — его календарь настроен с рождения.",
    qsRoutineAdd: "Добавить рутину",
    qsRoutineRemove: "Убрать",
    qsRoutinePrompt: "Что он делает при срабатывании рутины…",
    presetDaily9: "Каждый день в 9:00",
    presetWeekdays8: "По будням в 8:00",
    presetWeeklyMon9: "По понедельникам в 9:00",
    ...
    eqMcpHint: "Внешние подключения (MCP), доступные этому агенту.",
    eqMcpNone: "Для этого агента не настроены MCP-серверы.",
    eqActivityHint: "Последние сессии этого агента.",
    ...
    wfHint: "Как работает этот сотрудник, от начала до конца — нажмите на блок, чтобы открыть и настроить.",
    opsTab: "Операции",
    opsHint: "Доска задач команды. Создайте задачу, выберите исполнителя и запустите — агент работает сам и приносит результат на вашу проверку.",
    opsNewTask: "Новая задача",
    opsNewTaskHint: "Опишите, что нужно сделать и кто делает.",
    ...
    govTab: "Управление",
    govHint: "Взгляд владельца: сколько стоит каждый агент, сколько он работает и какова его автономия.",
    ...
    eqCanvasHint: "Ваша команда на живой карте — нажмите на агента, чтобы открыть его рентген; перетаскивайте для организации.",
    ...
    eqSkillsHint: "Что умеет этот агент. Отключите то, что не подходит его роли.",
    eqSkillsActive: "{on} из {total} включены",
    eqChannelsHint: "Где этот агент общается с миром.",
    ...
    templatesHint: "Один клик — и он в вашей команде.",
