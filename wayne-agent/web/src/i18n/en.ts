...
export const en: Translations = {
  ...
  status: {
    ...
    updateWayneConfirmTitle: "Update Wayne?",
    updatingWayne: "Updating Wayne…",
  ...
  chat: {
    ...
    working: "Working…",
    thinking: "Thinking",
    disclaimer: "Wayne can make mistakes. Double-check important information.",
    tasks: "Tasks",
    newTask: "New session",
    ...
    journeyEmpty: "Wayne has not learned anything here yet.",
    journeySkill: "Skill",
    ...
    previewEmptyHint: "Pick an .html file in the Files tab — pages Wayne generates show up here on their own.",
    ...
    notifyAsk: "Want to be notified when Wayne replies?",
    notifyEnable: "Notify me",
    notifyDone: "Done — come take a look.",
    notifyNeedsYouBody: "Wayne is waiting for you — an approval or reply is needed.",
    toolsOne: "tool",
    ...
    attachUrl: "URL…",
    steerPlaceholder: "Guide Wayne while it works…",
  ...
  agents: {
    ...
    qsHint: "Describe it in one sentence — Wayne drafts the configuration for you to review.",
    ...
    qsRoutine: "Routine",
    qsRoutineHint: "The agent runs on its own, on schedule — its agenda is born configured.",
    qsRoutineAdd: "Add routine",
    qsRoutineRemove: "Remove",
    qsRoutinePrompt: "What it does when the routine fires…",
    presetDaily9: "Every day at 9am",
    presetWeekdays8: "Weekdays at 8am",
    presetWeeklyMon9: "Mondays at 9am",
    ...
    eqMcpHint: "External connections (MCP) this agent can use.",
    eqMcpNone: "No MCP servers configured for this agent.",
    eqActivityHint: "Latest sessions of this agent.",
    ...
    wfServers: "{n} servers",
    wfResults: "Results",
    wfHint: "How this employee works, end to end — click a block to open and adjust it.",
    opsTab: "Operations",
    opsHint: "The team's task board. Create a task, pick who runs it, and dispatch — the agent works on its own and brings the result back for your review.",
    opsNewTask: "New task",
    opsNewTaskHint: "Describe what needs to be done and who does it.",
    opsTaskTitle: "Title",
    ...
    govTab: "Governance",
    govHint: "The owner's view: what each agent costs, how much it runs, and how much autonomy it has.",
    ...
    eqCanvasHint: "Your team on a living map — click an agent to open its X-ray; drag to arrange.",
    eqTabProfile: "Profile",
    eqTalk: "Chat",
    eqCost30d: "Cost · 30 days",
    eqSessions: "Sessions · 30 days",
    eqDefaultNote: "This is your Wayne's main agent — it can't be removed.",
    ...
    eqSkillsHint: "What this agent can do. Turn off what doesn't fit its role.",
    eqSkillsActive: "{on} of {total} enabled",
    eqChannelsHint: "Where this agent talks to the world.",
    ...
    templatesHint: "One click and it joins your team.",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Wayne plugins (`wayne plugins` parity).",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Wayne doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  configUser: {
    ...
    memoryNotifHint: "Shows a 'Memory updated' line in the chat when Wayne saves something new about you.",
    instructions: "Custom instructions",
    instructionsHint: "Tell your Wayne how you'd like to be treated and what it should know about you — name, role, tone. It uses this in every conversation.",
    ...
    planTab: "Plan & usage",
    defaultTier: "Wayne's default mode",
    ...
    notifyTurnDoneHint: "Notifies you when Wayne finishes a task while the tab is in the background.",
    notifyNeedsYou: "Needs you",
    notifyNeedsYouHint: "Notifies you when Wayne asks for approval or a reply.",
    memoryBudget: "Memory size",
    memoryBudgetHint: "How much context Wayne keeps between sessions.",
    budgetCompact: "Compact",
    budgetStandard: "Standard",
    budgetAmple: "Ample",
    writeApproval: "Approve new memories",
    writeApprovalHint: "Wayne asks for your confirmation before saving anything new to memory.",
    skills: "Skills",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Wayne badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Wayne session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Wayne more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Wayne sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Wayne is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
