...
def test_import_loads_env_from_wayne_home(tmp_path, monkeypatch):
    home = tmp_path / ".wayne"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-wayne-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-wayne-home"
