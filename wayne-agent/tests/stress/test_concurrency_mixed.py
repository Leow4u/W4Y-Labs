...
def worker_loop(worker_id: int, wayne_home: str, result_file: str) -> None:
...
def reclaimer_loop(wayne_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="wayne_mixed_stress_")
    print(f"WAYNE_HOME = {home}")
