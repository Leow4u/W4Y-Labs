...
def test_model_flow_nous_prints_subscription_guidance_without_mutating_explicit_tts(monkeypatch, capsys):
    monkeypatch.setattr(
        "work4you_cli.nous_subscription.managed_nous_tools_enabled",
    ...
    monkeypatch.setattr(
        "work4you_cli.auth.fetch_nous_models",
        lambda *args, **kwargs: ["claude-opus-4-6"],
    )
    monkeypatch.setattr("work4you_cli.auth._prompt_model_selection", lambda model_ids, current_model="", pricing=None, **kw: "claude-opus-4-6")
    monkeypatch.setattr("work4you_cli.auth._save_model_choice", lambda model: None)
    monkeypatch.setattr("work4you_cli.auth._update_config_for_provider", lambda provider, url: None)
...
def test_model_flow_nous_does_not_restore_stale_custom_api_key(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "work4you_cli.models.get_curated_nous_model_ids",
        lambda: [selected_model],
    )
    monkeypatch.setattr("work4you_cli.models.get_pricing_for_provider", lambda provider: {})
    monkeypatch.setattr("work4you_cli.models.check_nous_free_tier", lambda **kwargs: False)
    monkeypatch.setattr(
    ...
    monkeypatch.setattr(
        "work4you_cli.nous_subscription.prompt_enable_tool_gateway",
        lambda config: None,
    )
...
def test_model_flow_openrouter_clears_stale_custom_key(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "work4you_cli.main._prompt_api_key",
        lambda *args, **kwargs: ("sk-openrouter", False),
    )
    monkeypatch.setattr(
        "work4you_cli.models.model_ids",
        lambda **kwargs: ["anthropic/claude-sonnet-4.6"],
    )
    monkeypatch.setattr("work4you_cli.models.get_pricing_for_provider", lambda *a, **k: {})
    monkeypatch.setattr(
        "work4you_cli.auth._prompt_model_selection",
...
def test_model_flow_anthropic_clears_stale_custom_key_and_mode(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("work4you_cli.auth.get_anthropic_key", lambda: "sk-ant-api03-test")
    monkeypatch.setattr(
    ...
    monkeypatch.setattr(
        "work4you_cli.model_setup_flows._prompt_auth_credentials_choice",
        lambda title: "use",
    )
    monkeypatch.setattr(
        "work4you_cli.auth._prompt_model_selection",
...
def test_model_flow_nous_offers_tool_gateway_prompt_when_unconfigured(monkeypatch, capsys):
    ...
    monkeypatch.setattr("work4you_cli.setup.prompt_checklist", _fake_checklist, raising=False)
...
def test_cmd_model_falls_back_to_auto_on_invalid_provider(monkeypatch, capsys):
    ...
    monkeypatch.setattr("work4you_cli.auth.resolve_provider", _resolve_provider)
...
def test_cmd_model_forwards_nous_login_tls_options(monkeypatch):
    ...
    monkeypatch.setattr("work4you_cli.config.get_env_value", lambda key: "")
    monkeypatch.setattr("work4you_cli.config.save_env_value", lambda key, value: None)
    monkeypatch.setattr("work4you_cli.auth.resolve_provider", lambda requested, **kwargs: "nous")
