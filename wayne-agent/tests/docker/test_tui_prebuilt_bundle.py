...
The fix is ``ENV WAYNE_TUI_DIR=/opt/work4you/ui-tui`` in the Dockerfile, which
...
def test_tui_dir_env_is_set(built_image: str) -> None:
    ...
    assert r.stdout.strip() == "/opt/work4you/ui-tui", (
        f"WAYNE_TUI_DIR={r.stdout.strip()!r} (expected /opt/work4you/ui-tui)"
    )
