...
class TestMem0UserIdScoping:
    ...
    def test_no_user_id_no_config_uses_wayne_user(self):
        """Without user_id or config override, should default to 'wayne-user'."""
        from plugins.memory.mem0 import Mem0MemoryProvider
        ...
        assert provider._user_id == "wayne-user"
...
class TestAIAgentUserIdPropagation:
    ...
    def test_user_id_stored_on_agent(self):
        ...
        with patch.dict(os.environ, {"WAYNE_HOME": "/tmp/test_wayne"}):
