...
thinking phase.  Wayne's default cloud-stream stale detector
(``WAYNE_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``WAYNE_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
