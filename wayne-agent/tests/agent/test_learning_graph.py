...
def test_wayne_meta_tolerates_non_dict():
    assert learning_graph._wayne_meta({"metadata": "junk"}) == {}
    assert learning_graph._wayne_meta({"metadata": {"wayne": "junk"}}) == {}
    assert learning_graph._wayne_meta({"metadata": {"wayne": {"category": "x"}}}) == {"category": "x"}
