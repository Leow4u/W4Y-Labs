...
the shared /blueprint command handler (wayne_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated WAYNE_HOME for anything that touches the
cron job store.
"""
...
class TestCommandHandler:
    ...
    def test_name_match_is_forgiving(self, isolated_home):
        from wayne_cli.blueprint_cmd import handle_blueprint_command, match_blueprint
