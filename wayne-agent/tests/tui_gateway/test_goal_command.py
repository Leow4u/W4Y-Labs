...
def test_moa_bare_returns_usage(server, session, wayne_home):
    _write_moa_config(wayne_home, """
moa:
...
def test_moa_arg_is_always_one_shot(server, session, wayne_home):
...
def test_moa_non_preset_returns_one_shot_send(server, session, wayne_home):
    _write_moa_config(wayne_home, """
moa:
  default_preset: default
  presets:
