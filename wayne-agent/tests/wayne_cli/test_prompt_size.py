"""Tests for the ``wayne prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from wayne_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(wayne_home, memory_text="", user_text=""):
    mem_dir = wayne_home / "memories"
...
def _seed_skill(wayne_home, name, description):
    skill_dir = wayne_home / "skills" / "demo" / name
