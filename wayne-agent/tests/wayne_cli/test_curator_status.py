"""Tests for `wayne curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import wayne_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated WAYNE_HOME with real agent-created skills on disk."""
    home = tmp_path / ".wayne"
    skills = home / "skills"
    ...
    from wayne_cli import curator as curator_cli
