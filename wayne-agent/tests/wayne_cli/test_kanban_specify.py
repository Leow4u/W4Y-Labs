"""Tests for the specifier module + `wayne kanban specify` CLI surface.
...
from wayne_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `wayne kanban …` argparse surface directly."""
