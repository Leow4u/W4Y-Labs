"""Tests for the interactive session browser (`wayne sessions browse`).
...
from wayne_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """wayne sessions browse should be parseable."""
