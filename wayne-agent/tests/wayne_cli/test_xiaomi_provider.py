...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from wayne_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in WAYNE_OVERLAYS
        overlay = WAYNE_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify wayne doctor recognizes Xiaomi env vars."""
