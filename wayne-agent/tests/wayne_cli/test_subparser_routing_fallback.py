...
The main() function in wayne_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `wayne -c model`
...
def _build_parser():
    """Build a minimal replica of the wayne top-level parser."""
