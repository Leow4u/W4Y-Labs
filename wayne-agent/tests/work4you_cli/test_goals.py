...
class TestJudgeParseFailureAutoPause:
    ...
    def test_consecutive_parse_failures_persists_across_goalmanager_reloads(
        ...
        from work4you_cli import goals
        from work4you_cli.goals import GoalManager, load_goal
...
class TestMigrateGoalToSession:
    ...
    def test_no_goal_to_migrate_returns_false(self, wayne_home):
        from work4you_cli.goals import migrate_goal_to_session, load_goal
    ...
    def test_same_id_is_noop(self, wayne_home):
        from work4you_cli.goals import save_goal, migrate_goal_to_session, GoalState
    ...
    def test_cleared_goal_not_migrated(self, wayne_home):
        from work4you_cli.goals import save_goal, clear_goal, migrate_goal_to_session, load_goal, GoalState
