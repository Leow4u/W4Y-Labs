...
class TestVerifyConsoleScriptsInstalled:
    ...
    def test_skips_off_windows(self, temp_pyproject, fake_scripts_dir):
        with patch("work4you_cli.main._is_windows", return_value=False), \
             patch("work4you_cli.main._run_quarantined_install") as mock_install:
            from work4you_cli.main import _verify_console_scripts_installed
    ...
    def test_load_console_script_names_reads_pyproject(self, temp_pyproject):
        from work4you_cli.main import _load_console_script_names
    ...
    def test_primary_install_success_still_verifies_scripts(self):
        ...
        with patch("work4you_cli.main._is_windows", return_value=False), \
             patch("work4you_cli.main._run_quarantined_install") as mock_install, \
             patch("work4you_cli.main._verify_console_scripts_installed") as mock_verify:
