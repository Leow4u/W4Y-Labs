...
class TestPollForToken:
    ...
    def test_setup_result_includes_owner_user_id(self):
        ...
        with patch("work4you_cli.telegram_managed_bot.httpx.get", return_value=mock_resp):
            with patch("work4you_cli.telegram_managed_bot.time.sleep"):
    ...
    def test_invalid_ready_token_returns_none(self):
        ...
        with patch("work4you_cli.telegram_managed_bot.httpx.get", return_value=mock_resp):
            with patch("work4you_cli.telegram_managed_bot.time.sleep"):
                with patch(
                    "work4you_cli.telegram_managed_bot.time.monotonic"
                ) as mock_time:
...
class TestSetupTelegramAuto:
    ...
    def test_profile_name_from_home_path_handles_windows_separators(self):
        from work4you_cli.setup import _profile_name_from_wayne_home
