...
from work4you_cli.main import _web_ui_build_needed, _build_web_ui, _run_npm_install_deterministic
...
class TestBuildWebUISkipsWhenFresh:
    ...
    def test_runs_npm_when_dist_missing(self, tmp_path):
        ...
        with patch("work4you_cli.main.shutil.which", return_value="/usr/bin/npm"), \
             patch("work4you_cli.main.subprocess.run", return_value=mock_cp) as mock_run, \
             patch("work4you_cli.main._run_with_idle_timeout", return_value=build_ok) as mock_idle:
            result = _build_web_ui(web_dir)
    ...
    def test_npm_install_uses_utf8_replace_output_decoding(self, tmp_path):
        ...
        with patch("work4you_cli.main.subprocess.run", return_value=mock_cp) as mock_run:
    ...
    def test_npm_install_uses_workspace_web_scope(self, tmp_path):
        ...
        with patch("work4you_cli.main.shutil.which", return_value="/usr/bin/npm"), \
             patch("work4you_cli.main.subprocess.run", return_value=mock_cp) as mock_run, \
             patch("work4you_cli.main._run_with_idle_timeout", return_value=build_ok):
            result = _build_web_ui(web_dir)
        assert result is True
