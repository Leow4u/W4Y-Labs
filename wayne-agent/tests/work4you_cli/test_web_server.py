...
class TestWebServerEndpoints:
    ...
    def _setup_test_client(self, monkeypatch, _isolate_wayne_home):
        ...
        monkeypatch.setattr(work4you_state, "DEFAULT_DB_PATH", get_wayne_home() / "state.db")
    ...
    def test_update_wayne_returns_docker_guidance_without_spawning(self, monkeypatch):
        ...
        # Fork policy: never point at upstream Docker Hub images — Docker
        # installs rebuild from the checkout.
        assert "nousresearch" not in data["message"]
        assert "docker compose build" in data["update_command"]
        ...
        # Fork policy: guidance rebuilds from the checkout, never upstream hub.
        assert any("docker compose" in line for line in status_data["lines"])
        assert not any("nousresearch" in line for line in status_data["lines"])
    ...
    def test_get_env_vars_marks_platform_managed_keys(self):
        from work4you_cli.web_server import W4Y_PLATFORM_MANAGED_ENV
    ...
    def test_messaging_catalog_covers_gateway_platforms(self):
        ...
        from work4you_cli.web_server import _CHANNELS_UI_HIDDEN_PLATFORMS
    ...
    def test_path_traversal_dotdot_blocked(self):
        ...
        resp = self.client.get("/%2e%2e/work4you_cli/web_server.py")
        assert resp.status_code in {200, 404}
        if resp.status_code == 200:
    ...
    def test_set_model_main_nous_applies_gateway_defaults(self, monkeypatch):
        ...
        import work4you_cli.nous_subscription as ns
    ...
    def test_apply_main_model_assignment_base_url_and_context_reconcile(self):
        ...
        from work4you_cli.web_server import _apply_main_model_assignment
...
class TestBuildSchemaFromConfig:
    ...
    def test_empty_prefix_produces_correct_keys(self):
        from work4you_cli.web_server import _build_schema_from_config
...
class TestNewEndpoints:
    ...
    def test_skills_list_includes_disabled_skills(self, monkeypatch):
        ...
        import work4you_cli.skills_config as skills_config
        import work4you_cli.web_server as web_server
...
class TestDeleteSessionEndpoint:
    ...
    def _setup_test_client(self, monkeypatch, _isolate_wayne_home):
        ...
        monkeypatch.setattr(
            work4you_state, "DEFAULT_DB_PATH", get_wayne_home() / "state.db"
        )
