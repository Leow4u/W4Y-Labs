...
class TestNonInteractiveSetup:
    ...
    def test_cmd_setup_allows_noninteractive_flag_without_tty(self):
        ...
        from work4you_cli.main import cmd_setup

        args = _make_setup_args(non_interactive=True)

        with (
            patch("work4you_cli.setup.run_setup_wizard") as mock_run_setup,
    ...
    def test_non_interactive_flag_skips_wizard(self, capsys):
        ...
        with (
            patch("work4you_cli.setup.ensure_wayne_home"),
            patch("work4you_cli.setup.load_config", return_value={}),
            patch("work4you_cli.setup.get_wayne_home", return_value="/tmp/.wayne"),
            patch("work4you_cli.auth.get_active_provider", side_effect=AssertionError("wizard continued")),
