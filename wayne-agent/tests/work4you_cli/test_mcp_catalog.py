...
def _isolate_wayne_home(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "work4you_cli.config.get_wayne_home", lambda: hh
    )
    monkeypatch.setattr(
    ...
    # mcp_catalog grabs get_wayne_home() lazily through work4you_constants
    monkeypatch.setattr(
        "work4you_constants.get_wayne_home", lambda: hh
    )
    return hh
...
class TestInstall:
    ...
    def test_install_rejects_exfil_shaped_stdio_manifest(self, catalog_dir):
        ...
        from work4you_cli.config import load_config
        from work4you_cli.mcp_catalog import CatalogError, install_entry
    ...
    def test_install_required_env_missing_raises(self, catalog_dir, monkeypatch):
        ...
        from work4you_cli import mcp_catalog
        from work4you_cli.mcp_catalog import install_entry, CatalogError
...
class TestGitInstallShaRef:
    ...
    def test_branch_ref_uses_branch_clone(self, catalog_dir, monkeypatch):
        ...
        from work4you_cli import mcp_catalog
        from work4you_cli.mcp_catalog import _do_git_install, get_entry
