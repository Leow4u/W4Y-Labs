...
class TestVerifyCoreDependencies:
    ...
    def test_repair_reinstall_quarantines_running_shim_on_windows(
        ...
        with patch("work4you_cli.main._resolve_install_target_python", return_value=py), \
             patch("work4you_cli.main.subprocess.run", side_effect=fake_subprocess_run), \
             patch("work4you_cli.main._is_windows", return_value=True), \
             patch("work4you_cli.main._venv_scripts_dir", return_value=fake_scripts), \
             patch("work4you_cli.main._run_install_with_heartbeat"), \
             patch("work4you_cli.main._quarantine_running_wayne_exe", return_value=[]) as mock_quar:
