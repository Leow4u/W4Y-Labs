...
def test_dispatch_returns_false_on_host(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "work4you_cli.service_manager.detect_service_manager", lambda: "systemd",
    )
...
def test_dispatch_defaults_profile_to_default(
    ...
    monkeypatch.setattr(
        "work4you_cli.gateway._profile_suffix", lambda: "",
    )
...
def test_dispatch_renders_gateway_not_registered_friendly(
    ...
    from work4you_cli import gateway as gw
    from work4you_cli.service_manager import GatewayNotRegisteredError
    ...
    monkeypatch.setattr(
        "work4you_cli.service_manager.get_service_manager", lambda: _RaisesMissing(),
    )
...
def test_dispatch_renders_s6_command_error_friendly(
    ...
    monkeypatch.setattr(
        "work4you_cli.service_manager.get_service_manager", lambda: _RaisesS6Error(),
    )
...
def test_redirect_noop_on_host(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "work4you_cli.gateway.os.execvp",
...
def test_redirect_fires_inside_s6_container(
    ...
    monkeypatch.setattr("work4you_cli.gateway.os.execvp", fake_execvp)
...
def test_block_until_terminated_installs_sigterm_handler_and_blocks(
    ...
    monkeypatch.setattr(
        "work4you_cli.gateway.signal.signal",
    ...
    monkeypatch.setattr("work4you_cli.gateway.signal.pause", fake_pause)
