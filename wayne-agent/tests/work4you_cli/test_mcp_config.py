"""
Tests for work4you_cli.mcp_config — ``wayne mcp`` subcommands.
...
def _isolate_config(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "work4you_cli.config.get_wayne_home", lambda: tmp_path
    )
...
class TestMcpRemove:
    ...
    def test_remove_cleans_oauth_tokens(self, tmp_path, capsys, monkeypatch):
        ...
        monkeypatch.setattr(
            "work4you_cli.mcp_config.get_wayne_home", lambda: tmp_path
        )
...
class TestMcpAdd:
    ...
    def test_add_connection_failure_save_disabled(
        ...
        monkeypatch.setattr(
            "work4you_cli.mcp_config._probe_single_server", mock_probe_fail
        )
