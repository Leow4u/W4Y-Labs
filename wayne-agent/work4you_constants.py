...
def _get_platform_default_wayne_home() -> Path:
    ...
    name. The one-time data migration (work4you_cli.home_migration) moves
...
def get_wayne_home() -> Path:
    ...
    ``work4you_cli/kanban_db.py``).  See https://github.com/NousResearch/hermes-agent/issues/18594.
    """
