...
await build({
  ...
  // Skip the prebuilt @wayne/ink bundle and inline the source instead:
  ...
  alias: { '@wayne/ink': resolve(root, 'packages/wayne-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The wayne_cli launcher
