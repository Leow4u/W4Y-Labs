...
import type { ScrollBoxHandle } from '@wayne/ink'
import { evictInkCaches } from '@wayne/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.WAYNE_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
