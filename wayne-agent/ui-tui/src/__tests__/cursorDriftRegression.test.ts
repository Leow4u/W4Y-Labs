 ...
 *
 * Symptom: in `wayne --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@wayne/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using wayne --tui and as i type multiline my caret at the end will often ' +
